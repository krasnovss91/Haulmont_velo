package com.company.velo3.core.app;
...
public class ExtDeployer extends AbstractDeployer implements ExtDeployerMBean {
        ...
        try {
            ...
            String initDefaultInFirstStart = em.createQuery(
                    "select c.value from sys$Config c " +
                            "where c.name='velo3.initDefaultInFirstStart'",
                ...
                if (StringUtils.isNotBlank(edition) && Integer.parseInt(edition) > 1) {
                    ...
                    if (initDefaultInFirstStart == null) {
                        try {
                            ...
                            config.setName("velo3.initDefaultInFirstStart");
                        ...
                        try {
                            authentication.begin();
                            em.createQuery("update sys$Config c set c.value='false' where c.name='velo3.initDefaultInFirstStart'",
    ...
    protected void executeInitScripts() {
        ...
        File folderDB = new File(dbDirPath + "/50-velo3/init/" + dbmsType);

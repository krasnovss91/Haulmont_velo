...
postUpdate.add({
    ...
    def updateSql = "update DF_DOC d " +
            "set DOC_KIND_ID = '393c9da47d6111eab4a2b3c8deee0df1' " +
            "where d.DOC_KIND_ID = 'f147625a4ea84507956ff07ed302a5f1' and d.is_template = 0 " +
    ...
    try {
        ...
        def query = em.createNativeQuery("select ID from SYS_CATEGORY where ID = 'f147625a4ea84507956ff07ed302a5f1'")
        List list = query.getResultList()
        def oldDocKindExists = !list.isEmpty()
        if (oldDocKindExists) {
            query = em.createNativeQuery("select ID from SYS_CATEGORY where ID = '393c9da47d6111eab4a2b3c8deee0df1'")

...
if not exists (select * from SEC_GROUP where ID = '9fa89a54-9ffa-11e1-b13e-9f4a54bff17e') and
	...
	insert into SEC_GROUP select '9fa89a54-9ffa-11e1-b13e-9f4a54bff17e' as ID, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, name, parent_id
...
if not exists (select * from SEC_GROUP where ID = '8d9ba07c-9ffa-11e1-b99d-8fc5b41c7fbb') and
	...
	select '8d9ba07c-9ffa-11e1-b99d-8fc5b41c7fbb', create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, name, parent_id

...
update DF_DOC as d set AMOUNT = c.AMOUNT, VAT_INCLUSIVE = c.VAT_INCLUSIVE, VAT_RATE = c.VAT_RATE, VAT_AMOUNT = c.VAT_AMOUNT, CURRENCY_ID = c.CURRENCY_ID
    from DF_CONTRACT c where d.CARD_ID = c.CARD_ID^

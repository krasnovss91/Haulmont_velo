...
values ('0c018061-b26f-4de2-a5be-dff348347f93', current_timestamp, 1, 'Administrators', 10)^

insert into SEC_USER_ROLE (ID, CREATE_TS, VERSION, USER_ID, ROLE_ID)
values ('c838be0a-96d0-4ef4-a7c0-dff348347f93', current_timestamp, 1, '60885987-1b61-4247-94c7-dff348347f93', '0c018061-b26f-4de2-a5be-dff348347f93')^
...
alter table SEC_USER_SUBSTITUTION add NOTIFY_BY_CARD_INFO tinyint^
alter table SEC_USER_SUBSTITUTION add NOTIFY_BY_EMAIL tinyint^
...
create table TM_TASK_TYPE (
	...
	constraint TM_TASK_TYPE_CATEGORY_ID foreign key (CATEGORY_ID) references SYS_CATEGORY(ID)
)^
...
create table TM_TASK_GROUP (
	...
	constraint FK_TM_TASK_GROUP_CHAIRMAN foreign key (CHAIRMAN_ID) references SEC_USER(ID),
	constraint FK_TM_TASK_GROUP_SECRETARY foreign key (SECRETARY_ID) references SEC_USER(ID),
	constraint FK_TM_TASK_GROUP_INITIATOR foreign key (INITIATOR_ID) references SEC_USER(ID),
	constraint FK_TM_TASK_GROUP_CREATOR foreign key (CREATOR_ID) references SEC_USER(ID),
	constraint FK_TM_TASK_GROUP_SUBST_CREATOR foreign key (SUBSTITUTED_CREATOR_ID) references SEC_USER(ID),
	constraint FK_TM_TASK_GROUP_PARENT_CARD foreign key (PARENT_CARD_ID) references WF_CARD(ID)
)^

create clustered index IDX_TM_TASK_GROUP_CREATE_TS on TM_TASK_GROUP (CREATE_TS)^
...
create table TM_PROJECT_GROUP (
    ID uniqueidentifier not null,
    NAME varchar(100),
    PARENT_PROJECT_GROUP_ID uniqueidentifier,
    CREATE_TS datetime,
    CREATED_BY varchar(50),
    VERSION integer not null default 1,
    UPDATE_TS datetime,
    ...
    ORGANIZATION_ID uniqueidentifier,
    primary key nonclustered (ID),
	constraint FK_TM_PROJECT_GROUP_PRO_GROUP foreign key (PARENT_PROJECT_GROUP_ID) references TM_PROJECT_GROUP(ID)
)^

create clustered index IDX_TM_PROJECT_GROUP_CREATE_TS on TM_PROJECT_GROUP (CREATE_TS)^
...
create table TM_PROJECT (
    ID uniqueidentifier not null,
    NAME varchar(100),
    PROJECT_GROUP_ID uniqueidentifier,
    CREATE_TS datetime,
    CREATED_BY varchar(50),
    VERSION integer not null default 1,
    UPDATE_TS datetime,
	...
	TYPE varchar(1),
    primary key nonclustered (ID),
	constraint FK_TM_PROJECT_PROJECT_GROUP foreign key (PROJECT_GROUP_ID) references TM_PROJECT_GROUP(ID)
)^

create clustered index IDX_TM_PROJECT_CREATE_TS on TM_PROJECT (CREATE_TS)^
...
create table TM_TASK (
    ...
    FULL_DESCR varchar(max),
    HIDDEN tinyint,
    PERCENT_COMPLETION numeric(3),
    LABOUR_INTENSITY numeric(5,2),
    DURATION numeric(5,2),
    START_DATETIME_FACT datetime,
    FINISH_DATE_PLAN datetime,
    FINISH_DATETIME_PLAN datetime,
    FINISH_DATE_FACT datetime,
    FINISH_DATETIME_FACT datetime,
    TIME_UNIT varchar(1),
    ...
    INITIATOR_ID uniqueidentifier,
    CONTROL_ENABLED tinyint,
    REFUSE_ENABLED tinyint,
    REASSIGN_ENABLED tinyint,
    LABOUR_UNIT varchar(1),
    LABOUR_HOUR numeric(7,2),
    CONFIRM_REQUIRED tinyint,
    PRIMARY_TASK_ID uniqueidentifier,
    SCHEDULE_TASK_ID uniqueidentifier,
    ORGANIZATION_ID uniqueidentifier,
    PROJECT_ID uniqueidentifier,

    primary key nonclustered (CARD_ID),
	constraint FK_TM_TASK_CARD foreign key (CARD_ID) references WF_CARD(ID),
	constraint FK_TM_TASK_TASK_TYPE foreign key (TASK_TYPE_ID) references TM_TASK_TYPE(CATEGORY_ID),
	constraint FK_TM_TASK_PRIORITY foreign key (PRIORITY_ID) references TM_PRIORITY(ID),
	constraint FK_TM_TASK_EXECUTOR_USER foreign key (EXECUTOR_ID) references SEC_USER(ID),
	constraint FK_TM_TASK_INITIATOR_USER foreign key (INITIATOR_ID) references SEC_USER(ID),
	constraint FK_TM_TASK_TASK foreign key (PRIMARY_TASK_ID) references TM_TASK(CARD_ID),
	constraint FK_TM_TASK_PROJECT foreign key(PROJECT_ID) references TM_PROJECT(ID)
)^

create clustered index IDX_TM_TASK_CREATE_TS on TM_TASK (CREATE_TS)^

create index IDX_TM_TASK_CARD on TM_TASK (CARD_ID)^
...
create clustered index IDX_TM_TASK_PATTERN_GROUP_CREATE_TS on TM_TASK_PATTERN_GROUP (CREATE_TS)^
...
create table TM_TASK_PATTERN (
    ...
    PROJECT_ID uniqueidentifier,
    primary key nonclustered (CARD_ID),
	constraint FK_TM_TASK_PATTERN_CARD foreign key (CARD_ID) references WF_CARD(ID),
	constraint FK_TM_TASK_PATTERN_TASK_TYPE foreign key (TASK_TYPE_ID) references TM_TASK_TYPE(CATEGORY_ID),
	constraint FK_TM_TASK_PATTERN_PRIORITY foreign key (PRIORITY_ID) references TM_PRIORITY(ID),
	constraint FK_TASK_PATTERN_PROJECT foreign key(PROJECT_ID) references TM_PROJECT(ID)
)^

create clustered index IDX_TM_TASK_PATTERN_CREATE_TS on TM_TASK_PATTERN (CREATE_TS)^

create index IDX_TM_TASK_PATTERN_CARD on TM_TASK_PATTERN (CARD_ID)^


------------------------------------------------------------------------------------------------------------

create table TM_TASK_PATTERN_GROUP_TASK_PAT (
    TASK_PATTERN_GROUP_ID uniqueidentifier not null,
    TASK_PATTERN_ID uniqueidentifier,
    CREATE_TS datetime,
    CREATED_BY varchar(50),
    VERSION integer not null default 1,
    UPDATE_TS datetime,
    ...
    DELETE_TS datetime,
    DELETED_BY varchar(50),
	constraint FK_TM_TPG_TP_TASK_PATTERN_GROUP foreign key (TASK_PATTERN_GROUP_ID) references TM_TASK_PATTERN_GROUP(ID),
	constraint FK_TM_TPG_TP_TASK_PATTERN foreign key (TASK_PATTERN_ID) references TM_TASK_PATTERN(CARD_ID)
)^

create clustered index IDX_TM_TASK_PATTERN_GROUP_TASK_PATTERN_TASK_PATTERN_GROUP on TM_TASK_PATTERN_GROUP_TASK_PAT (TASK_PATTERN_GROUP_ID )^
...
create table TM_TASK_INFO (
    ...
    primary key nonclustered (ID),
	constraint FK_TM_TASK_INFO_TASK foreign key (TASK_ID) references TM_TASK(CARD_ID),
	constraint FK_TM_TASK_INFO_USER foreign key (USER_ID) references SEC_USER(ID)
)^

create clustered index IDX_TM_TASK_INFO_CREATE_TS on TM_TASK_INFO (CREATE_TS)^
...
create table TM_TASK_GROUP_TASK (
    ...
    START_DATETIME_FACT datetime,
    HAS_TASK tinyint,
    IS_TASK_FINISHED tinyint,
    primary key nonclustered (ID),
	constraint FK_TM_TASK_GROUP_TASK_PROFILE foreign key (TASK_GROUP_ID) references TM_TASK_GROUP(ID),
	constraint FK_TM_TASK_GROUP_TASK_TASK foreign key (TASK_ID) references TM_TASK(CARD_ID),
	constraint FK_TM_TASK_GROUP_TASK_USER foreign key (USER_ID) references SEC_USER(ID),
	constraint FK_DF_INITIATOR_USER foreign key (INITIATOR_ID) references SEC_USER(ID),
	constraint FK_TM_TASK_GROUP_TASK_TASK_TYPE foreign key (TASK_TYPE_ID) references TM_TASK_TYPE(CATEGORY_ID),
	constraint FK_TM_TASK_GROUP_TASK_PRIORITY foreign key (PRIORITY_ID) references TM_PRIORITY(ID),
	constraint FK_TM_TASK_GROUP_TASK_CONTROLLER foreign key (CONTROLLER_ID) references SEC_USER(ID),
	constraint FK_TM_TASK_GROUP_TASK_PROJECT foreign key (PROJECT_ID) references TM_PROJECT(ID)
)^

create clustered index IDX_TM_TASK_GROUP_TASK_CREATE_TS on TM_TASK_GROUP_TASK (CREATE_TS)^
...
create table TM_REMINDER(
    ...
    DELETED_BY varchar(50),
    primary key nonclustered (ID),
	constraint FK_TM_REMINDER_CARD foreign key (CARD_ID) references WF_CARD(ID),
	constraint FK_TM_REMINDER_USER foreign key (USER_ID) references SEC_USER(ID)
)^

create clustered index IDX_TM_REMINDER_CREATE_TS on TM_REMINDER (CREATE_TS)^
...
create table DF_NUMERATOR (
    ...
    DELETED_BY varchar(50),
    CODE varchar(255),
    LOC_NAME varchar(max),
    SCRIPT varchar(4000),
    SCRIPT_ENABLED tinyint,
    NUMERATOR_FORMAT varchar(max),
    PERIODICITY varchar(1),
    NUMBER_INITIAL_VALUE integer default 1,
    primary key nonclustered (ID)
)^

create clustered index IDX_DF_NUMERATOR_CREATE_TS on DF_NUMERATOR (CREATE_TS)^
...
create table DF_DOC_KIND (
    ...
    CODE varchar(50),
    DESCRIPTION varchar(200),
    FIELDS_XML varchar(max),
    NUMERATOR_ID uniqueidentifier,
    NUMERATOR_TYPE integer,
    PREFIX varchar(100),
    CATEGORY_ATTRS_PLACE integer,
    CATEGORY_ID uniqueidentifier,
    USE_ALL_PROCS tinyint,
    PORTAL_PUBLISH_ALLOWED tinyint,
    DISABLE_ADD_PROCESS_ACTORS tinyint,
    CREATE_ONLY_BY_TEMPLATE tinyint,
    AVAILABLE_TO_CREATE_ON_MOB_CL tinyint constraint DF_DOC_KIND_AVAIL_TO_CR_DEF default 1,
    ORGANIZATION_ID uniqueidentifier,
    TAB_NAME varchar(30),
    primary key nonclustered (CATEGORY_ID),
	constraint FK_DF_DOC_KIND_NUMERATOR foreign key (NUMERATOR_ID) references DF_NUMERATOR (ID),
	constraint DF_DOC_KIND_CATEGORY_ID foreign key (CATEGORY_ID) references SYS_CATEGORY(ID)
)^

create clustered index IDX_DF_DOC_KIND_CREATE_TS on DF_DOC_KIND (CREATE_TS)^
...
create table TS_CARD_TYPE (
    ...
    DOC_KIND_ID uniqueidentifier,
    DOC_TEMPLATE_ID uniqueidentifier,
    FIELDS_XML varchar(max),
    primary key (ID)
)^
...
create table DF_CATEGORY (
    ...
    ORGANIZATION_ID uniqueidentifier,
    primary key (ID),
	constraint FK_DF_CATEGORY_DOC_TYPE foreign key (DOC_TYPE_ID) references TS_CARD_TYPE (ID)
)^
...
create index IDX_DF_CATEGORY_DOC_TYPE on DF_CATEGORY (DOC_TYPE_ID)^
...
create clustered index IDX_DF_ORGANIZATION_CREATE_TS on DF_ORGANIZATION (CREATE_TS)^
...
create clustered index IDX_DF_DOC_RECEIVING_METHOD_CREATE_TS on DF_DOC_RECEIVING_METHOD (CREATE_TS)^
...
create table DF_CORRESPONDENT (
    ...
    HAS_ATTACHMENTS tinyint,
    primary key nonclustered (ID),
	constraint FK_DF_CORRESPONDENT_ORGANIZAT foreign key (ORGANIZATION_ID) references DF_ORGANIZATION(ID)
)^

create clustered index IDX_DF_CORRESPONDENT_CREATE_TS on DF_CORRESPONDENT (CREATE_TS)^

------------------------------------------------------------------------------------------------------------

create table DF_CONTRACTOR (
    CORRESPONDENT_ID uniqueidentifier not null,
    CREATE_TS datetime,
    CREATED_BY varchar(50),
    VERSION integer not null default 1,
    UPDATE_TS datetime,
    ...
    COMMENT_ varchar(1000),
    WEBSITE varchar(300),
    NON_RESIDENT tinyint,
    SUPPLIER tinyint,
    CUSTOMER tinyint,
    primary key nonclustered (CORRESPONDENT_ID),
	constraint FK_DF_CONTRACTOR_CORRESPONDENT foreign key (CORRESPONDENT_ID) references DF_CORRESPONDENT(ID)
)^

create clustered index IDX_DF_CONTRACTOR_CREATE_TS on DF_CONTRACTOR (CREATE_TS)^
...
create table DF_COMPANY (
    ...
    OGRN varchar(15),
    KPP varchar(9),
    primary key nonclustered (CONTRACTOR_ID),
	constraint FK_DF_COMPANY_CONTRACTOR foreign key (CONTRACTOR_ID) references DF_CONTRACTOR (CORRESPONDENT_ID)
)^

create clustered index IDX_DF_COMPANY_CREATE_TS on DF_COMPANY (CREATE_TS)^

create index IDX_DF_COMPANY_CONTRACTOR on DF_COMPANY (CONTRACTOR_ID)^
...
create table DF_INDIVIDUAL (
    ...
    PASSPORT_GIVEN_WHEN datetime,
    BIRTH_DATE datetime,
    EGRIP varchar(15),
    primary key nonclustered (CONTRACTOR_ID),
	constraint FK_DF_INDIVIDUAL_CONTRACTOR foreign key (CONTRACTOR_ID) references DF_CONTRACTOR (CORRESPONDENT_ID)
)^

create clustered index IDX_DF_INDIVIDUAL_CREATE_TS on DF_INDIVIDUAL (CREATE_TS)^

create index IDX_DF_INDIVIDUAL_CONTRACTOR on DF_INDIVIDUAL (CONTRACTOR_ID)^
...
create table DF_CONTACT_PERSON (
    ...
    SEX varchar(1),
    INITIALS_FIRST tinyint,
    primary key nonclustered (ID),
	constraint FK_DF_CONTACT_PERSON_COMPANY foreign key (COMPANY_ID) references DF_COMPANY (CONTRACTOR_ID)
)^

create clustered index IDX_DF_CONTACT_PERSON_CREATE_TS on DF_CONTACT_PERSON (CREATE_TS)^
...
create table DF_BANK_REGION (
    ...
    OKATO varchar(9),
    REG_ID varchar(9),
    UPLOAD_FROM_CBR tinyint,
    primary key nonclustered(ID)
)^

create clustered index IDX_DF_BANK_REGION_CREATE_TS on DF_BANK_REGION (CREATE_TS)^
...
create table DF_BANK (
    ...
    BANK_REGION_ID uniqueidentifier,
    TYPE varchar(2),
    ADDRESS varchar(300),
    SHORT_NAME varchar(200),
    UPLOAD_FROM_CBR tinyint,
    PARENT_BANK_ID uniqueidentifier,
    primary key nonclustered (ID),
	constraint FK_DF_BANK_BANK_REGION foreign key (BANK_REGION_ID) references DF_BANK_REGION (ID),
	constraint FK_DF_BANK_PARENT_BANK foreign key (PARENT_BANK_ID) references DF_BANK (ID)
)^

create clustered index IDX_DF_BANK_PERSON_CREATE_TS on DF_BANK (CREATE_TS)^
...
create clustered index IDX_DF_CURRENCY_CREATE_TS on DF_CURRENCY (CREATE_TS)^
...
create table DF_CONTRACTOR_ACCOUNT (
    ...
    INDIRECT_CALC_BANK_ID uniqueidentifier,
    TYPE varchar(1),
    primary key nonclustered (ID),
	constraint FK_DF_CONTRACTOR_ACCOUNT_CONT foreign key (CONTRACTOR_ID) references DF_CONTRACTOR (CORRESPONDENT_ID),
	constraint FK_DF_CONTRACTOR_ACCOUNT_CURR foreign key (CURRENCY_ID) references DF_CURRENCY (ID),
	constraint FK_DF_CONTRACTOR_ACCOUNT_BANK foreign key (BANK_ID) references DF_BANK (ID),
	constraint FK_DF_CONTRACTOR_ACCOUNT_DF_B foreign key (INDIRECT_CALC_BANK_ID) references DF_BANK (ID)
)^

create clustered index IDX_DF_CONTRACTOR_ACCOUNT_CREATE_TS on DF_CONTRACTOR_ACCOUNT (CREATE_TS)^
...
create table DF_ORGANIZATION_ACCOUNT (
    ...
    TYPE varchar(1),
    primary key nonclustered (ID),
	constraint FK_DF_ORGANIZATION_ACCOUNT_CO foreign key (ORGANIZATION_ID) references DF_ORGANIZATION (ID),
	constraint FK_DF_ORGANIZATION_ACCOUNT_CU foreign key (CURRENCY_ID) references DF_CURRENCY (ID),
	constraint DF_ORGANIZATION_ACCOUNT_BANK foreign key (BANK_ID) references DF_BANK (ID),
	constraint DF_ORGANIZATION_ACCOUNT_DF_BA foreign key (INDIRECT_CALC_BANK_ID) references DF_BANK (ID)
)^

create clustered index IDX_DF_ORGANIZATION_ACCOUNT_CREATE_TS on DF_ORGANIZATION_ACCOUNT (CREATE_TS)^
...
create table DF_DEPARTMENT (
    ...
    CREATE_TS datetime default current_timestamp,
    CODE varchar(20),
    PARENT_DEPARTMENT_ID uniqueidentifier,
    primary key nonclustered (CORRESPONDENT_ID),
	constraint FK_DF_DEPARTMENT_DEPARTMENT foreign key (PARENT_DEPARTMENT_ID) references DF_DEPARTMENT (CORRESPONDENT_ID),
	constraint FK_DF_DEPARTMENT_CORRESPONDENT foreign key (CORRESPONDENT_ID) references DF_CORRESPONDENT(ID)
)^
...
create table DF_OFFICE_FILE_NOMENCLATURE (
    ...
    ORGANIZATION_ID uniqueidentifier,
    PARENT_NOMENCLATURE_ID uniqueidentifier,
    DEPARTMENT_ID uniqueidentifier,
    SUBSTITUTED_CREATOR_ID uniqueidentifier,
    DOC_KIND varchar(1),
    primary key nonclustered (ID),
	constraint FK_DF_OF_NOMENCL_ORGANIZATION foreign key (ORGANIZATION_ID) references DF_ORGANIZATION(ID),
	constraint FK_DF_OF_NOMENCL_NOMENCLATURE foreign key (PARENT_NOMENCLATURE_ID) references DF_OFFICE_FILE_NOMENCLATURE(ID),
	constraint FK_DF_OF_NOMENCL_DEPARTMENT foreign key (DEPARTMENT_ID) references DF_DEPARTMENT (CORRESPONDENT_ID),
	constraint FK_DF_OF_NOMENCL_TO_SEC_USER foreign key (SUBSTITUTED_CREATOR_ID) references SEC_USER(ID)
)^

create clustered index IDX_DF_OFFICE_FILE_NOMENCLATURE_CREATE_TS on DF_OFFICE_FILE_NOMENCLATURE (CREATE_TS)^
...
create table DF_OFFICE_FILE (
    ...
    STATE integer,
    OFFICE_FILE_NOMENCLATURE_ID uniqueidentifier,
    NUMERATOR_ID uniqueidentifier,
    SUBSTITUTED_CREATOR_ID uniqueidentifier,
    ORGANIZATION_ID uniqueidentifier,
    primary key nonclustered (ID),
	constraint FK_DF_OFFICE_FILE_NOMENCLATURE foreign key (OFFICE_FILE_NOMENCLATURE_ID) references DF_OFFICE_FILE_NOMENCLATURE(ID),
	constraint FK_DF_OFFICE_FILE_NUMERATOR foreign key (NUMERATOR_ID) references DF_NUMERATOR(ID),
	constraint FK_DF_OFFICE_FILE_SUBSTITUTED_CREATOR foreign key (SUBSTITUTED_CREATOR_ID) references SEC_USER(ID)
)^

create clustered index IDX_DF_OFFICE_FILE_CREATE_TS on DF_OFFICE_FILE (CREATE_TS)^
...
create table DF_EMPLOYEE (
    ...
    PHOTO_FILE_ID uniqueidentifier,
    AVATAR_FILE_ID uniqueidentifier,
    MOBILE_AVATAR_FILE_ID uniqueidentifier,
    FACSIMILE_FILE_ID uniqueidentifier,
    BIRTHDAY datetime,
    EDM_CERTIFICATE_THUMBPRINT varchar(255),
    primary key nonclustered (CORRESPONDENT_ID),
	constraint FK_DF_EMPLOYEE_DEPARTMENT foreign key (DEPARTMENT_ID) references DF_DEPARTMENT (CORRESPONDENT_ID),
	constraint FK_DF_EMPLOYEE_USER foreign key (USER_ID) references SEC_USER (ID),
	constraint FK_DF_EMPLOYEE_CORRESPONDENT foreign key (CORRESPONDENT_ID) references DF_CORRESPONDENT(ID),
	constraint FK_DF_EMPLOYEE_SYS_FILE foreign key (PHOTO_FILE_ID) references SYS_FILE (ID),
	constraint FK_DF_EMPLOYEE_AVATAR_FILE_ID foreign key (AVATAR_FILE_ID) references SYS_FILE(ID),
	constraint FK_DF_EMPL_MOB_AVATAR_FILE_ID foreign key (MOBILE_AVATAR_FILE_ID) references SYS_FILE(ID),
	constraint FK_DF_EMPLOYEE_FACSIMILE_FILE_ID foreign key (FACSIMILE_FILE_ID) references SYS_FILE(ID)
)^
...
create table DF_DOC (
    ...
    REGISTERED tinyint,
    DOUBLE_REGISTERED tinyint,
    FINISH_DATE_PLAN datetime,
    OVERDUE tinyint,
    GLOBAL tinyint,
    REG_NO varchar(50),
    REG_DATE datetime,
    ENDORSEMENT_START_DATE datetime,
    ENDORSEMENT_END_DATE datetime,
    APPROVAL_DATE datetime,
    ENDORSED tinyint,
    AVAILABLE_FOR_ALL tinyint,
    THEME varchar(650),
    ARCHIVED tinyint,
    PROJECT_ID uniqueidentifier,
    ...
    CONTRACTOR_ID uniqueidentifier,
    AMOUNT numeric(19,2),
    VAT_INCLUSIVE tinyint,
    VAT_RATE numeric(19,2),
    VAT_AMOUNT numeric(19,2),
    CURRENCY_ID uniqueidentifier,
    primary key nonclustered (CARD_ID),

	constraint FK_DF_DOC_CARD foreign key (CARD_ID) references WF_CARD (ID),
	constraint FK_DF_DOC_VERSION_OF foreign key (VERSION_OF_ID) references WF_CARD (ID),
	constraint FK_DF_DOC_DOC_KIND foreign key (DOC_KIND_ID) references DF_DOC_KIND (CATEGORY_ID),
	constraint FK_DF_DOC_CATEGORY foreign key (CATEGORY_ID) references DF_CATEGORY (ID),
	constraint FK_DF_DOC_EMPLOYEE foreign key (OWNER_ID) references DF_EMPLOYEE (CORRESPONDENT_ID),
	constraint FK_DF_DOC_DEPARTMENT foreign key (DEPARTMENT_ID) references DF_DEPARTMENT (CORRESPONDENT_ID),
	constraint FK_DF_DOC_ORGANIZATION foreign key (ORGANIZATION_ID) references DF_ORGANIZATION(ID),
	constraint FK_DF_DOC_PROJECT foreign key(PROJECT_ID) references TM_PROJECT(ID),
	constraint FK_DF_DOC_CONTRACTOR foreign key (CONTRACTOR_ID) references DF_CONTRACTOR (CORRESPONDENT_ID),
	constraint FK_DF_DOC_CURRENCY foreign key (CURRENCY_ID) references DF_CURRENCY (ID)
)^
...
create index IDX_DOC_TEMPLATE_VERSION_NUM on DF_DOC(IS_TEMPLATE, VERSION_OF_ID, NUMBER_)^
...
create table DF_SIMPLE_DOC (
    ...
    primary key nonclustered  (CARD_ID),
	constraint FK_DF_SIMPLE_DOC_DOC foreign key (CARD_ID) references DF_DOC (CARD_ID),
    constraint FK_DF_SIMPLE_DOC_EMPLOYEE_0 foreign key (DOC_SENDER_ID) references DF_EMPLOYEE (CORRESPONDENT_ID),
    constraint FK_DF_SIMPLE_DOC_EMPLOYEE_1 foreign key (DOC_RECEIVER_ID) references DF_EMPLOYEE (CORRESPONDENT_ID),
    constraint FK_DF_SIMPLE_DOC_EMPLOYEE_2 foreign key (DOC_COPY_RECEIVER_ID) references DF_EMPLOYEE (CORRESPONDENT_ID)
)^

create clustered index IDX_DF_SIMPLE_DOC_CREATE_TS on DF_SIMPLE_DOC (CREATE_TS)^

create index IDX_DF_SIMPLE_DOC_CARD on DF_SIMPLE_DOC (CARD_ID)^
...
create clustered index IDX_DF_DOC_EXTRA_FIELD_CREATE_TS on DF_DOC_EXTRA_FIELD (CREATE_TS)^
...
create table DF_CONTRACT (
    ...
    CREATE_TS datetime default current_timestamp,
    IS_ACTIVE tinyint,
    PAYMENT_CONDITIONS varchar(max),
    LIABILITY_START datetime,
    LIABILITY_END datetime,
    NOTIFIED_CREATOR tinyint,
    NOTIFIED_OWNER tinyint,
...
create clustered index IDX_DF_CONTRACT_CREATE_TS on DF_CONTRACT (CREATE_TS)^

create index IDX_DF_CONTRACT_CARD on DF_CONTRACT (CARD_ID)^
...
create table DF_DOC_OFFICE_DATA (
    ...
    RESPONSE_TO_DOC_ID uniqueidentifier,
    SENDER_ID uniqueidentifier,
    OFFICE_FILE_ID uniqueidentifier,
    DOC_RECEIVING_METHOD_ID uniqueidentifier,
    OFFICE_EXECUTOR_ID uniqueidentifier ,
    OFFICE_SIGNED_BY_ID uniqueidentifier,
    EMPLOYEE_EXECUTOR_ID uniqueidentifier,
    EMPLOYEE_SIGNED_BY_ID uniqueidentifier,
    RESPONSE_PLAN_DATE datetime,
...
create clustered index IDX_DF_DOC_OFFICE_DATA_CREATE_TS on DF_DOC_OFFICE_DATA (CREATE_TS)^
...
create table DF_DOC_TRANSFER_LOG (
    ...
    DELETED_BY varchar(50),
    TYPE integer,
    DOC_OFFICE_DATA_ID uniqueidentifier,
...
create clustered index IDX_DF_DOC_TRANSFER_LOG_CREATE_TS on DF_DOC_TRANSFER_LOG (CREATE_TS)^
...
alter table WF_ATTACHMENT add SIGN tinyint;
alter table WF_ATTACHMENT add TASK_GROUP_ID uniqueidentifier^
...
create clustered index IDX_TM_SCHEDULE_TASK_CREATE_TS on TM_SCHEDULE_TASK (CREATE_TS)^
...
create clustered index IDX_TM_SCHEDULE_TRIGGER_CREATE_TS on TM_SCHEDULE_TRIGGER (CREATE_TS)^
...
create table TM_SCHEDULE_ACTION (
    ...
    SCHEDULE_TASK_ID uniqueidentifier,
    SCHEDULE_ACTION_TYPE_ID uniqueidentifier,
    DISCRIMINATOR integer,
    primary key nonclustered (ID)
);
...
create clustered index IDX_TM_SCHEDULE_ACTION_CREATE_TS on TM_SCHEDULE_ACTION (CREATE_TS)^

---------------------------------------------------------------------------------------------------

create table TM_START_TASK_SCHEDULE_ACTION (
    SCHEDULE_ACTION_ID uniqueidentifier,
    TASK_PATTERN_ID uniqueidentifier,
    SCRIPT varchar(3000),
    NOTIFY_INITIATOR tinyint,
    SCRIPT_ENABLED tinyint,
    ORGANIZATION_ID uniqueidentifier,
...
create clustered index IDX_TM_SCHEDULE_ACTION_LOG_CREATE_TS on TM_SCHEDULE_ACTION_LOG (CREATE_TS)^
...
create clustered index IDX_WF_CARD_USER_INFO_CREATE_TS on WF_CARD_USER_INFO (CREATE_TS)^
...
create table DF_DOC_OFFICE_DATA_ADDRESSEE (
    ...
    DELETED_BY varchar(50),
    DOC_OFFICE_DATA_ID uniqueidentifier,
    CORRESPONDENT_ID uniqueidentifier,
    CONTACT_PERSON_ID uniqueidentifier,
    primary key nonclustered (ID)
)^
...
create clustered index IDX_DF_DOC_OFFICE_DATA_ADDRESSEE_CREATE_TS on DF_DOC_OFFICE_DATA_ADDRESSEE (CREATE_TS)^
...
create table TS_CARD_ACL (
    ...
    DEPARTMENT_ID uniqueidentifier,
    CODE integer,
    BASE_ACL_ID uniqueidentifier,
    primary key nonclustered (ID),
       constraint FK_TS_CARD_ACL_WF_CARD foreign key (CARD_ID) references WF_CARD(ID),
       constraint FK_TS_CARD_ACL_TEMPLATE_CARD foreign key (TEMPLATE_ID) references WF_CARD(ID),
       ...
       constraint FK_TS_CARD_ACL_DF_DEPARTMENT foreign key (DEPARTMENT_ID) references DF_CORRESPONDENT(ID),
       constraint FK_TS_CARD_ACL_BASE_CARD_ACL foreign key (BASE_ACL_ID) references TS_CARD_ACL(ID)
);
...
create index IDX_TS_CARD_ACL_ORGANIZATION on TS_CARD_ACL(ORGANIZATION_ID) include (CARD_ID);
...
create table TM_LAZY_LOAD_ATTACHMENT (
    ...
    DELETED_BY varchar(50),
    primary key (ID),
    constraint TM_LAZY_LOAD_ATTACHM_FILE_ID foreign key (FILE_ID) references SYS_FILE (ID)
)^
...
create table DF_SUB_CARD_INFO (
      ...
      CREATE_TS datetime,
      CREATED_BY varchar(50),
      SUB_CARD_ID uniqueidentifier not null,
      PARENT_CARD_ID uniqueidentifier not null,
      SUB_CARD_CREATED_ASSIGNMENT_ID uniqueidentifier,
      RESOLUTION_ASSIGNMENT_ID uniqueidentifier,
      ACTIVE tinyint,
      TYPE varchar(1),
      primary key (ID)
);
...
alter table SEC_USER add IS_MOBILE tinyint^
alter table SEC_USER add ACTIVE_DIRECTORY_ID varchar(255)^
alter table SEC_USER add USE_ACTIVE_DIRECTORY tinyint^
...
---------------------------------------------------------------------------------------------------
alter table REPORT_REPORT add OVERWRITE_BY_INIT tinyint;

---------------------------------------------------------------------------------------------------

alter table SEC_GROUP add AD_GROUP_NAME varchar(255);
alter table SEC_GROUP add LOC_NAME varchar(max);
alter table SEC_ROLE add AD_GROUP_NAME varchar(255);
...
alter table WF_PROC_APP_FOLDER add CARDS_SELECT_SCRIPT varchar(max);
---------------------------------------------------------------------------------------------------
...
CREATE TABLE TS_OPERATOR_EDM(
    ...
    last_doc_event_date datetime,
    last_doc_event_ai_key varchar(255),
    primary key nonclustered(id)
)^

create clustered index IDX_TS_OPERATOR_EDM_CREATE_TS on TS_OPERATOR_EDM (CREATE_TS)^
...
CREATE TABLE TS_SUBSCRIBER_EDM(
    ...
    box_id varchar(255),
    contractor_id uniqueidentifier,
    operator_edm_id uniqueidentifier,

    primary key nonclustered(id),
    constraint TS_SUBSCR_EDM_CONR_ID foreign key (CONTRACTOR_ID) references DF_CONTRACTOR(CORRESPONDENT_ID),
    constraint TS_SUBSCR_EDM_OPER_EDM_ID foreign key (OPERATOR_EDM_ID) references TS_OPERATOR_EDM(ID)
)^

create clustered index IDX_TS_SUBSCRIBER_EDM_CREATE_TS on TS_SUBSCRIBER_EDM (CREATE_TS)^
...
CREATE TABLE TS_EDM_SENDING (
    ...
    RESPONSE_SIGNATURE_REQUIRED tinyint,
    primary key nonclustered(ID)
)^
...
insert into SEC_GROUP (id, create_ts, created_by, version, name, parent_id) values ('cff945e4-e363-0dc0-d70d-4b5bdb2a2269',current_timestamp,'system',1,'Архивариус', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93');
insert into SEC_GROUP (id, create_ts, created_by, version, name, parent_id) values ('7dfe5c72-073f-4e1e-9cf4-1b1bad9c0093',current_timestamp,'system',1,'Делопроизводители','0fa2b1a5-1d68-4d69-9fbd-dff348347f93');
insert into SEC_GROUP (id, create_ts, created_by, version, name, parent_id) values ('8e6306e2-9e10-414a-b437-24c91ffef804',current_timestamp,'system',1,'Ограниченный доступ','0fa2b1a5-1d68-4d69-9fbd-dff348347f93');
insert into SEC_GROUP (id, create_ts, created_by, version, name, parent_id) values ('9e44a053-a31f-4edd-b19b-39e942161dd2',current_timestamp,'system',1,'Ограниченный доступ + все договоры','0fa2b1a5-1d68-4d69-9fbd-dff348347f93');
insert into SEC_GROUP (id, create_ts, created_by, version, name, parent_id) values ('b3dc60f5-65b2-47ab-8802-9e8929bf8b29',current_timestamp,'system',1,'Ограниченный доступ + все документы','0fa2b1a5-1d68-4d69-9fbd-dff348347f93');
insert into SEC_GROUP (id, create_ts, created_by, version, name, parent_id) values ('9fa89a54-9ffa-11e1-b13e-9f4a54bff17e',current_timestamp,'system',1,'Руководитель департамента', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93');
insert into SEC_GROUP (id, create_ts, created_by, version, name, parent_id) values ('8d9ba07c-9ffa-11e1-b99d-8fc5b41c7fbb',current_timestamp,'system',1,'Руководитель подразделения', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93')^

update SEC_GROUP set LOC_NAME = '{"captionWithLanguageList":[{"language":"ru","caption":"Полный доступ"},{"language":"en","caption":"Full access"}]}' where ID = '0fa2b1a5-1d68-4d69-9fbd-dff348347f93'^
update SEC_GROUP set LOC_NAME = '{"captionWithLanguageList":[{"language":"ru","caption":"Ограниченный доступ"},{"language":"en","caption":"Limited access"}]}' where ID = '8e6306e2-9e10-414a-b437-24c91ffef804'^
update SEC_GROUP set LOC_NAME = '{"captionWithLanguageList":[{"language":"ru","caption":"Делопроизводители"},{"language":"en","caption":"Secretary"}]}' where ID = '7dfe5c72-073f-4e1e-9cf4-1b1bad9c0093'^
update SEC_GROUP set LOC_NAME = '{"captionWithLanguageList":[{"language":"ru","caption":"Руководитель подразделения"},{"language":"en","caption":"Assistant Manager"}]}' where ID = '8d9ba07c-9ffa-11e1-b99d-8fc5b41c7fbb'^
update SEC_GROUP set LOC_NAME = '{"captionWithLanguageList":[{"language":"ru","caption":"Руководитель департамента"},{"language":"en","caption":"Head of Department"}]}' where ID = '9fa89a54-9ffa-11e1-b13e-9f4a54bff17e'^
update SEC_GROUP set LOC_NAME = '{"captionWithLanguageList":[{"language":"ru","caption":"Ограниченный доступ + все договоры"},{"language":"en","caption":"Limited access + all contracts"}]}' where ID = '9e44a053-a31f-4edd-b19b-39e942161dd2'^
update SEC_GROUP set LOC_NAME = '{"captionWithLanguageList":[{"language":"ru","caption":"Ограниченный доступ + все документы"},{"language":"en","caption":"Limited access + all documents"}]}' where ID = 'b3dc60f5-65b2-47ab-8802-9e8929bf8b29'^
update SEC_GROUP set LOC_NAME = '{"captionWithLanguageList":[{"language":"ru","caption":"Архивариус"},{"language":"en","caption":"Archivist"}]}' where ID = 'cff945e4-e363-0dc0-d70d-4b5bdb2a2269'^

insert into SEC_GROUP_HIERARCHY (id,create_ts,created_by,group_id,parent_id,hierarchy_level)
values (newid(), current_timestamp, 'system', '8e6306e2-9e10-414a-b437-24c91ffef804', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93', 0);
insert into SEC_GROUP_HIERARCHY (id,create_ts,created_by,group_id,parent_id,hierarchy_level)
values (newid(), current_timestamp, 'system', '7dfe5c72-073f-4e1e-9cf4-1b1bad9c0093', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93', 0);
insert into SEC_GROUP_HIERARCHY (id,create_ts,created_by,group_id,parent_id,hierarchy_level)
values (newid(), current_timestamp, 'system', '9fa89a54-9ffa-11e1-b13e-9f4a54bff17e', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93', 0);
insert into SEC_GROUP_HIERARCHY (id,create_ts,created_by,group_id,parent_id,hierarchy_level)
values (newid(), current_timestamp, 'system', '8d9ba07c-9ffa-11e1-b99d-8fc5b41c7fbb', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93', 0);
insert into SEC_GROUP_HIERARCHY (id,create_ts,created_by,group_id,parent_id,hierarchy_level)
values (newid(), current_timestamp, 'system', 'b3dc60f5-65b2-47ab-8802-9e8929bf8b29', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93', 0);
insert into SEC_GROUP_HIERARCHY (id,create_ts,created_by,group_id,parent_id,hierarchy_level)
values (newid(), current_timestamp, 'system', '9e44a053-a31f-4edd-b19b-39e942161dd2', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93', 0);
insert into SEC_GROUP_HIERARCHY (id,create_ts,created_by,group_id,parent_id,hierarchy_level)
values (newid(), current_timestamp, 'system', 'cff945e4-e363-0dc0-d70d-4b5bdb2a2269', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93', 0)^

--Полный доступ
insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values ('cbd897a2-5c4d-4b84-a613-6393c435cbcc',current_timestamp,'system',1,'sec$User',null,'{E}.createdBy is not null','0fa2b1a5-1d68-4d69-9fbd-dff348347f93');

--Ограничения для wf$UserGroup для всех кроме "Полный доступ"
insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
select newid(), current_timestamp, 'system', 1, 'wf$UserGroup', null, '{E}.substitutedCreator.id = :session$userId or {E}.global = true', ID from SEC_GROUP where ID <> '0fa2b1a5-1d68-4d69-9fbd-dff348347f93'^
--Ограничения для df$TypicalResolution для всех кроме "Полный доступ"
insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
select newid(), current_timestamp, 'system', 1, 'df$TypicalResolution', null, '{E}.substitutedCreator.id = :session$userId or {E}.global = true', ID from SEC_GROUP where ID <> '0fa2b1a5-1d68-4d69-9fbd-dff348347f93'^

--Архивариус
insert into SEC_CONSTRAINT(id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id) values
('bc94a0d4-10ca-11e4-8fb1-07511252f87c', current_timestamp, 'system', 1, 'df$Doc',
 'left outer join {E}.docOfficeData dod left outer join dod.officeFile file',
 'file.state >= 30 and {E}.template = false or {E}.id in (select acl.card.id from ts$CardAcl acl where acl.user.id = :session$userId or acl.global = true)', 'cff945e4-e363-0dc0-d70d-4b5bdb2a2269');

insert into SEC_CONSTRAINT(id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id) values
('c42e9fa2-10ca-11e4-9c89-8758c81c5f95', current_timestamp, 'system', 1, 'tm$Task', null, 'exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and acl.user.id = :session$userId)', 'cff945e4-e363-0dc0-d70d-4b5bdb2a2269');

insert into SEC_CONSTRAINT(id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id) values
('c646b7e8-10ca-11e4-9ac6-5b5381a1ae07', current_timestamp, 'system', 1, 'tm$TaskPattern', null, 'exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and (acl.user.id = :session$userId or acl.global = true))', 'cff945e4-e363-0dc0-d70d-4b5bdb2a2269');

insert into SEC_CONSTRAINT(id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id) values
('ce7b9b22-10ca-11e4-8ecc-a3cabbbb49b3', current_timestamp, 'system', 1, 'tm$TaskGroup',
...
--Делопроизводители
insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values ('433c5a9a-991f-454c-a064-861a74a66c88',current_timestamp,'system',1,'tm$Task',null,'exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and acl.user.id = :session$userId)','7dfe5c72-073f-4e1e-9cf4-1b1bad9c0093');

insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values ('edda0d21-3aa0-40df-8100-19444d75535c',current_timestamp,'system',1,'tm$TaskPattern',null,'exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and (acl.user.id = :session$userId or acl.global = true))', '7dfe5c72-073f-4e1e-9cf4-1b1bad9c0093');

insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values ('86c0ba0a-5c2e-11e0-b52d-0f8fb8df9d93',current_timestamp,'system',1,'tm$TaskGroup','left join {E}.taskGroupTasks tgt left join tgt.task t',
...
--Ограниченный доступ
insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values ('22581acc-acff-4d58-bc8d-ffaea3dd01fa',current_timestamp,'system',1,'df$Doc',null,'exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and (acl.user.id = :session$userId or acl.global = true))','8e6306e2-9e10-414a-b437-24c91ffef804');

insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values ('bcb90482-e02a-42f3-b936-a40b28b5963a',current_timestamp,'system',1,'tm$Task',null,'exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and acl.user.id = :session$userId)','8e6306e2-9e10-414a-b437-24c91ffef804');

insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values ('cb37a982-a1fe-4082-b0ea-440f4211af8d',current_timestamp,'system',1,'tm$TaskPattern',null,'exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and (acl.user.id = :session$userId or acl.global = true))', '8e6306e2-9e10-414a-b437-24c91ffef804');

insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values ('7b87c520-5c2e-11e0-a770-b3d23ae5dd33',current_timestamp,'system',1,'tm$TaskGroup','left join {E}.taskGroupTasks tgt left join tgt.task t',
...
insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values ('99961b6f-d798-479c-9b93-04b16a99ff62',current_timestamp,'system',1,'df$Doc',null,'TYPE({E}) in (:session$contractEffectiveClass) or exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and (acl.user.id = :session$userId or acl.global = true))','9e44a053-a31f-4edd-b19b-39e942161dd2');

insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values ('a4fd0af5-9884-4076-97fd-aa291cdaba13',current_timestamp,'system',1,'tm$Task',null,'exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and acl.user.id = :session$userId)','9e44a053-a31f-4edd-b19b-39e942161dd2');

insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values ('70170bc4-1b83-4829-b51c-17c19cf7c6db',current_timestamp,'system',1,'tm$TaskPattern',null,'exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and (acl.user.id = :session$userId or acl.global = true))', '9e44a053-a31f-4edd-b19b-39e942161dd2');

insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values ('b9647fb6-33a6-4240-a07d-c63eb19e5e1d',current_timestamp,'system',1,'tm$TaskGroup','left join {E}.taskGroupTasks tgt left join tgt.task t',
...
insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values ('3f520104-d798-479c-9b93-04b16a99ff62',current_timestamp,'system',1,'df$Doc',null,'TYPE({E}) in (:session$simpleDocEffectiveClass, :session$accountDocEffectiveClass, :session$packageDocEffectiveClass) or exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and (acl.user.id = :session$userId or acl.global = true))','b3dc60f5-65b2-47ab-8802-9e8929bf8b29');

insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values ('3f520104-c1d0-4877-a331-522a53a372b3',current_timestamp,'system',1,'tm$Task',null,'exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and acl.user.id = :session$userId)','b3dc60f5-65b2-47ab-8802-9e8929bf8b29');

insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values ('c3096def-c3eb-4580-b9e6-da6a71407f50',current_timestamp,'system',1,'tm$TaskPattern',null,'exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and (acl.user.id = :session$userId or acl.global = true))', 'b3dc60f5-65b2-47ab-8802-9e8929bf8b29');

insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values ('8c876c9a-d973-43ed-8837-b01a8219146d',current_timestamp,'system',1,'tm$TaskGroup','left join {E}.taskGroupTasks tgt left join tgt.task t',
...
insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values (newid(), current_timestamp, 'system', 1, 'df$Doc', null, 'exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and (acl.user.id = :session$userId or acl.department.id in :session$departmentIds or acl.global = true))',
...
insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values (newid(), current_timestamp, 'system', 1, 'tm$Task', null, 'exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and (acl.department.id in :session$departmentIds or acl.user.id = :session$userId))',
'8d9ba07c-9ffa-11e1-b99d-8fc5b41c7fbb');
insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values (newid(), current_timestamp, 'system', 1, 'tm$Task', null, 'exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and (acl.department.id in :session$departmentIds or acl.user.id = :session$userId))',
'9fa89a54-9ffa-11e1-b13e-9f4a54bff17e');
...
insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values (newid(), current_timestamp, 'system', 1, 'tm$TaskPattern',null,'exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and (acl.user.id = :session$userId or acl.global = true))',
'8d9ba07c-9ffa-11e1-b99d-8fc5b41c7fbb');
insert into SEC_CONSTRAINT (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id)
values (newid(), current_timestamp, 'system', 1, 'tm$TaskPattern',null,'exists (select acl.id from ts$CardAcl acl where acl.card.id = {E}.id and (acl.user.id = :session$userId or acl.global = true))',
'9fa89a54-9ffa-11e1-b13e-9f4a54bff17e');
...
insert into SEC_ROLE (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,name,loc_name,description,is_default_role) VALUES ('5115e833-4146-4c98-a119-1c06053adb92',current_timestamp,'admin',1,current_timestamp,null,null,null,'schedule_task_creator','Создание периодических задач','Роль, позволяющая создавать периодические задания',null);
INSERT INTO SEC_ROLE (ID, CREATE_TS, CREATED_BY, VERSION, NAME, LOC_NAME,DESCRIPTION) VALUES ('5cd3839e-781b-487f-8810-4091943da63b', current_timestamp, USER, 1, 'DepartmentChief', 'Руководитель департамента','Эта роль выдается только совместно с группой доступа «Руководитель департамента». У пользователя с этой ролью в карточке сотрудника должно быть заполнено подразделение');
INSERT INTO SEC_ROLE (ID, CREATE_TS, CREATED_BY, VERSION, NAME, LOC_NAME,DESCRIPTION) VALUES ('2ba2e5ca-a00d-11e1-82a7-832770c8a361', current_timestamp, USER, 1, 'SubdivisionChief', 'Руководитель подразделения','Эта роль выдается только совместно с группой доступа «Руководитель подразделения». У пользователя с этой ролью в карточке сотрудника должно быть заполнено подразделение');
INSERT INTO sec_role (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,name,loc_name,description,is_default_role) VALUES ('b6a03cd4-0479-11e1-b6c9-77dd813b99ee',current_timestamp,'admin',1,current_timestamp,null,null,null,'UserSubstitutionEditor','Редактирование замещений пользователей','Роль предоставляет возможность редактирования справочника «Замещение пользователей»', null);
INSERT INTO SEC_ROLE (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,name,loc_name,description,is_default_role) VALUES ('e8b73444-cb05-11e2-b014-d7054a634646',current_timestamp,'admin',1,current_timestamp,null,null,null,'AppIntegrationRole','Доступ к функциям модуля интеграции с учётными системами','Позволяет отмечать справочники и данные к выгрузке в сторонние учётные системы',null);
...
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('9e75c7eb-a430-44f7-8b51-b9f6db4dd90f', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$DocIncome.browse', 1, '7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('6ed2a5df-8d7c-42ac-8eef-e1bf0edc95a9', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$DocInternal.browse', 1, '7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('33dd26ac-a1d8-4894-a7b1-5afe0a069773', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$OfficeFileNomenclature.browse', 1, '7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('0db798c7-98ab-41ce-82ce-7eb116953554', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$DocReceivingMethod.browse', 1, '7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('88d0aa5c-3b84-42c5-b715-ccd24bcf59d8', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$DocOutcome.browse', 1, '7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('e76d68f8-4e4a-4972-b1e5-6e19e0381e1d', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$OfficeFile.browse', 1, '7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('b525fcc6-2963-4c95-ab53-736d513d2e87', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$OfficeFile.browse', 0, '96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('ce5eea18-6112-4e8c-9354-31f70f557151', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$DocReceivingMethod.browse', 0, '96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('76eaa12b-4d9c-45e6-8265-4e88241d6c8d', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$OfficeFileNomenclature.browse', 0, '96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('a275efde-db56-483d-8d44-675336311faa', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$DocIncome.browse', 0, '96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('deddf997-f5d2-4512-96ef-49b41be754af', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$DocOutcome.browse', 0, '96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('5a8d93b9-c2ac-454d-b88b-16967973a54e', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$DocInternal.browse', 0, '96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('3ccc3e08-6c9a-11df-b69f-abdb42ff7f18', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'sec$User.edit', 0, '96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('2dc3ec4c-b733-11df-932a-2b8e44e58220', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'jmxConsole', 0, '96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('76a6977a-b733-11df-b52a-fb44c9d29968', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'core$Entity.restore', 0, '96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('e75f3112-aa0c-4bac-8025-e5af579595f8', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, null, null, null, 20, 'df$Doc:delete', 1, '3c9abffb-2fae-484e-990c-343b3c1197ca');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('e889f226-ddeb-4f7a-80fa-5f368ab6aa34', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, null, null, null, 20, 'df$Doc:create', 1, '3c9abffb-2fae-484e-990c-343b3c1197ca');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('5b503fe4-aec9-4186-9271-bdc077315eb0', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, null, null, null, 20, 'df$Doc:update', 1, '3c9abffb-2fae-484e-990c-343b3c1197ca');

INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('b9bf7d7f-8242-4fde-b550-e33d8c0c0545', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'systemSettings', 0, '96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value_, role_id) VALUES ('d9212fa1-a02d-48e3-896c-81c741fb2c5b', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'systemSettings', 1, '0c018061-b26f-4de2-a5be-dff348347f93');

INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value_,role_id) VALUES ('826c59e4-593d-11e0-afdc-87a3d5cee637',null,'admin',1,null,null,null,null,40,'cuba.gui.showInfo',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
---------------------------------------------------------------------------------------------------

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'tm$Project:update',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');

---------------------------------------------------------------------------------------------------

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$DocKind:create',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$DocKind:update',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$DocKind:delete',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,'admin',1,10,'sys$Category.browse',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c')^

-----------------------------------------------------------------------------------------------------

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$OfficeFile:create',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$OfficeFile:update',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$OfficeFile:delete',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$OfficeFileNomenclature:create',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$OfficeFileNomenclature:update',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$OfficeFileNomenclature:delete',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$OfficeFileNomenclature:create',1,'7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$OfficeFileNomenclature:update',1,'7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$OfficeFileNomenclature:delete',1,'7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$OfficeFile:create',1,'7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$OfficeFile:update',1,'7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$OfficeFile:delete',1,'7091f5ef-a77a-450a-834a-39406885676e');

----------------------------------------------------------------------------------------------------
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'wf$AttachmentType:create',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'wf$AttachmentType:update',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'wf$AttachmentType:delete',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:create',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:update',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:delete',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:create',1,'c06c0cee-2f21-4241-8d6f-76b4cd462f96');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:update',1,'c06c0cee-2f21-4241-8d6f-76b4cd462f96');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:delete',1,'c06c0cee-2f21-4241-8d6f-76b4cd462f96');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:create',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:update',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:delete',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'wf$AttachmentType:create',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'wf$AttachmentType:update',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,20,'wf$AttachmentType:delete',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,USER,1,10,'df$TypicalResolution.browse',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');
----------------------------------------------------------------------------------------------------
...
INSERT INTO SEC_PERMISSION (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value_,role_id) VALUES ('0c0110cf-75fc-4588-98ab-9b0ea7427f60',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'tm$ScheduleTask.browse',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO SEC_PERMISSION (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value_,role_id) VALUES ('4b498d47-05ce-4bdc-a598-163799386316',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'tm$ScheduleActionType.browse',1,'0c018061-b26f-4de2-a5be-dff348347f93');
INSERT INTO SEC_PERMISSION (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value_,role_id) VALUES ('8be19e1d-973d-4491-9df9-ed30ff785ba9',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'tm$ScheduleActionType.browse',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO SEC_PERMISSION (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value_,role_id) VALUES ('8f402cc1-2540-47cb-9807-2fd56abedee5',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'tm$ScheduleTask.browse',1,'5115e833-4146-4c98-a119-1c06053adb92');
-------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value_,role_id) VALUES ('41fd6ef4-047b-11e1-9dae-b795ca9a4604',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'df$UserSubstitution.browse',1,'b6a03cd4-0479-11e1-b6c9-77dd813b99ee');
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value_,role_id) VALUES ('757377c4-0480-11e1-a7ae-df74fc362788',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'df$UserSubstitution.edit',1,'b6a03cd4-0479-11e1-b6c9-77dd813b99ee');
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value_,role_id) VALUES ('7a7b4f44-0480-11e1-8d1d-7ff443e73f88',current_timestamp,'admin',1,current_timestamp,null,null,null,20,'sec$UserSubstitution:create',1,'b6a03cd4-0479-11e1-b6c9-77dd813b99ee');
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value_,role_id) VALUES ('7f168244-0480-11e1-87ca-b77b6e8c1e4b',current_timestamp,'admin',1,current_timestamp,null,null,null,20,'sec$UserSubstitution:update',1,'b6a03cd4-0479-11e1-b6c9-77dd813b99ee');
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value_,role_id) VALUES ('83b055b4-0480-11e1-8afd-978c96b5602f',current_timestamp,'admin',1,current_timestamp,null,null,null,20,'sec$UserSubstitution:delete',1,'b6a03cd4-0479-11e1-b6c9-77dd813b99ee');

INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value_,role_id) VALUES ('8b17059e-045a-11e1-9ff0-5b3f364a9175',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'df$UserSubstitution.browse',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value_,role_id) VALUES ('567d2324-0480-11e1-8725-13795b5a61a9',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'df$UserSubstitution.edit',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');

----------------------------------------------------------------------------------------------------
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value_,role_id) VALUES ('a6935664-885e-11e1-9248-83ef391ff91f',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'printDomain',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value_,role_id) VALUES ('83140af2-885f-11e1-9aa3-876f4796e54c',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'printDomain',1,'0c018061-b26f-4de2-a5be-dff348347f93');
...
----------------------------------------------------------------------------------------------------
INSERT INTO SEC_PERMISSION (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,'admin',1,current_timestamp,null,null,null,10,'assistantWebSocketStatuses',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO SEC_PERMISSION (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value_,role_id) VALUES (newid(),current_timestamp,'admin',1,current_timestamp,null,null,null,10,'assistantWebSocketStatuses',0,'0c018061-b26f-4de2-a5be-dff348347f93');
----------------------------------------------------------------------------------------------------
INSERT INTO sec_permission (id,create_ts,update_ts,created_by,version,permission_type,target,value_,role_id) VALUES ('c0972ef2-631c-448b-9d47-6738fe4caf92',current_timestamp,current_timestamp,'admin',1,20,'ts$OperatorEdm:create',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,update_ts,created_by,version,permission_type,target,value_,role_id) VALUES ('5792b007-83bd-4d9b-9f10-44af7b4fff86',current_timestamp,current_timestamp,'admin',1,20,'ts$OperatorEdm:update',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,update_ts,created_by,version,permission_type,target,value_,role_id) VALUES ('5de976a9-5ccb-4bce-90da-96fb429eb920',current_timestamp,current_timestamp,'admin',1,20,'ts$OperatorEdm:delete',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,update_ts,created_by,version,permission_type,target,value_,role_id) VALUES ('6e0bb2cb-4708-422f-960d-9a0dfffd1420',current_timestamp,current_timestamp,'admin',1,20,'ts$OperatorEdm:read',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,update_ts,created_by,version,permission_type,target,value_,role_id) VALUES ('c3dd2cb7-e232-492a-b894-cc7552435aa4',current_timestamp,current_timestamp,'admin',1,10,'ts$OperatorEdm.browse',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
----------------------------------------------------------------------------------------------------
INSERT INTO sec_permission (id,create_ts,update_ts,created_by,version,permission_type,target,value_,role_id) VALUES ('b902b79d-4423-4ccc-9a8e-40799b017b57',current_timestamp,current_timestamp,'admin',1,20,'ts$SubscriberEdm:create',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,update_ts,created_by,version,permission_type,target,value_,role_id) VALUES ('5a86e217-4dab-4d27-a322-0626b9cde9ee',current_timestamp,current_timestamp,'admin',1,20,'ts$SubscriberEdm:update',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,update_ts,created_by,version,permission_type,target,value_,role_id) VALUES ('8b63b7e3-a740-4823-93c9-96e8e79c95d8',current_timestamp,current_timestamp,'admin',1,20,'ts$SubscriberEdm:delete',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,update_ts,created_by,version,permission_type,target,value_,role_id) VALUES ('25dbe4f0-b23c-4a04-9f89-21476d6fb6fe',current_timestamp,current_timestamp,'admin',1,20,'ts$SubscriberEdm:read',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,update_ts,created_by,version,permission_type,target,value_,role_id) VALUES ('0f39428b-c042-4a4d-b350-0fdf25bc6d9d',current_timestamp,current_timestamp,'admin',1,10,'ts$SubscriberEdm.browse',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
----------------------------------------------------------------------------------------------------
INSERT INTO sec_permission (id,create_ts,update_ts,created_by,version,permission_type,target,value_,role_id) VALUES ('e4d9f371-7773-439d-bb50-62a906b7252d',current_timestamp,current_timestamp,'admin',1,20,'ts$EdmSending:update',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,update_ts,created_by,version,permission_type,target,value_,role_id) VALUES ('46086834-c2ac-4e18-92f0-97008f9f96fe',current_timestamp,current_timestamp,'admin',1,20,'ts$EdmSending:delete',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,update_ts,created_by,version,permission_type,target,value_,role_id) VALUES ('cfcc3054-3f65-42aa-8cc6-dbc74c8e585d',current_timestamp,current_timestamp,'admin',1,20,'ts$EdmSending:read',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,update_ts,created_by,version,permission_type,target,value_,role_id) VALUES ('a761f635-f6f4-4bf3-82b7-37c97ad19d08',current_timestamp,current_timestamp,'admin',1,10,'ts$EdmSending.browse',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
----------------------------------------------------------------------------------------------------

insert into WF_CALENDAR (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) values ('91ac3881-fd81-4e54-a0a5-165d795ccd73',current_timestamp,'admin',current_timestamp,null,null,1,null,null);
insert into WF_CALENDAR (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) values ('161b69cf-ec53-43b7-bdfb-b60ec8815cb4',current_timestamp,'admin',current_timestamp,null,null,2,{t '09:00:00'},{t '13:00:00'});
insert into WF_CALENDAR (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) values ('e87c4db4-eb7a-4a35-ace0-29b6bb63095f',current_timestamp,'admin',current_timestamp,null,null,2,{t '14:00:00'},{t '18:00:00'});
insert into WF_CALENDAR (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) values ('9b64d3ab-1132-4f40-ac2b-bb8df7ec25c6',current_timestamp,'admin',current_timestamp,null,null,3,{t '09:00:00'},{t '13:00:00'});
insert into WF_CALENDAR (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) values ('d31a2aec-cc9f-464a-8302-e43f8b92a8c5',current_timestamp,'admin',current_timestamp,null,null,3,{t '14:00:00'},{t '18:00:00'});
insert into WF_CALENDAR (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) values ('868958ec-2b0c-487f-b192-3a2b086d73e3',current_timestamp,'admin',current_timestamp,null,null,4,{t '09:00:00'},{t '13:00:00'});
insert into WF_CALENDAR (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) values ('8368e326-689c-4c61-b234-5d35b88a9270',current_timestamp,'admin',current_timestamp,null,null,4,{t '14:00:00'},{t '18:00:00'});
insert into WF_CALENDAR (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) values ('7726565f-daf6-4dfe-858c-f8cf71aef0ce',current_timestamp,'admin',current_timestamp,null,null,5,{t '09:00:00'},{t '13:00:00'});
insert into WF_CALENDAR (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) values ('17c2861e-b578-425d-8579-02f6dea3f87b',current_timestamp,'admin',current_timestamp,null,null,5,{t '14:00:00'},{t '18:00:00'});
insert into WF_CALENDAR (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) values ('950e60d9-9f1a-42a3-91e9-5392fa1f8ef9',current_timestamp,'admin',current_timestamp,null,null,6,{t '09:00:00'},{t '13:00:00'});
insert into WF_CALENDAR (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) values ('bb8b0b04-fc16-45c3-a377-36044a371014',current_timestamp,'admin',current_timestamp,null,null,6,{t '14:00:00'},{t '18:00:00'});
insert into WF_CALENDAR (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) values ('d06a8ef6-8324-4c1f-a022-eb939d048cb3',current_timestamp,'admin',current_timestamp,null,null,7,null,null);

------------------------------------------------------------------------------------------------------------

INSERT INTO tm_priority (id,name,order_no,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by) VALUES ('2562cb31-0ebc-477b-a124-1cc618108be3','Нормальный',3,{ts '2010-01-26 10:22:08.280'},'admin',2,{ts '2010-01-26 14:39:36.920'},'admin',null,null);
INSERT INTO tm_priority (id,name,order_no,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by) VALUES ('36518fcf-6fe9-42a9-ada2-e45b7e545cfa','Высокий',2,{ts '2010-01-26 10:22:12.300'},'admin',2,{ts '2010-01-26 14:39:39.520'},'admin',null,null);
INSERT INTO tm_priority (id,name,order_no,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by) VALUES ('6d40219c-b258-45f0-96ef-2d3da048e76f','Низкий',4,{ts '2010-01-26 10:22:18.690'},'admin',2,{ts '2010-01-26 14:39:41.880'},'admin',null,null)^
INSERT INTO tm_priority (id,name,order_no,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by) VALUES ('9567d315-1880-46ac-94ee-65de44e7e3e4','Критический',1,{ts '2010-03-04 10:16:43.750'},'admin',2,{ts '2010-03-04 10:17:31.560'},'admin',null,null)^
...
values ('144feeb6-5ad8-11e0-a80d-cf59394498a5','AttachmentType.executorAttachment',0)^
-------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------
delete from SEC_FILTER where id = 'b61d18cb-e79a-46f3-b16d-eaf4aebb10dd'^
...
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='report$ReportGroup.browse', @p_type=10, @p_value=0^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='report$Report.edit', @p_type=10, @p_value=0^
exec create_or_update_sec_permissi @r_name='Administrators', @p_target='report$ReportGroup.browse', @p_type=10, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sys$ScheduledTask.browse', @p_type=10, @p_value=0^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sys$ScheduledTask.edit', @p_type=10, @p_value=0^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='performanceStatistics', @p_type=10, @p_value=0^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='screenProfiler', @p_type=10, @p_value=0^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='entityInspector.browse', @p_type=10, @p_value=0^

exec create_or_update_sec_permissi @r_name='ReferenceEditor', @p_target='df$Department:update', @p_type=20, @p_value=1^
exec create_or_update_sec_permissi @r_name='Administrators', @p_target='tm$Task:delete', @p_type=20, @p_value=1^
...
select newid(), current_timestamp, 'admin', 1, null, null, null, null, 40, 'thesis.userGroup.edit.global', 1, ID from SEC_ROLE where NAME in ('Administrators', 'ReferenceEditor')
^

insert into SEC_PERMISSION (ID, CREATE_TS, CREATED_BY, VERSION, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, PERMISSION_TYPE, TARGET, VALUE_, ROLE_ID)
select newid(), current_timestamp, 'admin', 1, null, null, null, null, 40, 'thesis.userGroup.edit.global', 0, ID from SEC_ROLE where NAME = 'SimpleUser'
^
...
exec create_or_update_sec_permissi @r_name='Administrators', @p_target='df$Organization.browse', @p_type=10, @p_value=1^
...
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='wf$UserNotifiedBySms.browse', @p_type=10, @p_value=0^
exec create_or_update_sec_permissi @r_name='Administrators', @p_target='wf$UserNotifiedBySms.browse', @p_type=10, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='wf$SendingSms.browse', @p_type=10, @p_value=0^
exec create_or_update_sec_permissi @r_name='Administrators', @p_target='wf$SendingSms.browse', @p_type=10, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='df$FastRegistration', @p_type=10, @p_value=0^
exec create_or_update_sec_permissi @r_name='doc_secretary', @p_target='df$FastRegistration', @p_type=10, @p_value=1^
exec create_or_update_sec_permissi @r_name='Administrators', @p_target='df$FastRegistration', @p_type=10, @p_value=1^

exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='userMobileBrowse', @p_type=10, @p_value=0^
exec create_or_update_sec_permissi @r_name='Administrators', @p_target='userMobileBrowse', @p_type=10, @p_value=1^

exec create_or_update_sec_permissi @r_name='ReferenceEditor', @p_target='df$CorrespondentAttachment:create', @p_type=20, @p_value=1^
exec create_or_update_sec_permissi @r_name='ReferenceEditor', @p_target='df$CorrespondentAttachment:update', @p_type=20, @p_value=1^
exec create_or_update_sec_permissi @r_name='ReferenceEditor', @p_target='df$CorrespondentAttachment:delete', @p_type=20, @p_value=1^

exec create_or_update_sec_permissi @r_name='Administrators', @p_target='df$CorrespondentAttachment:create', @p_type=20, @p_value=1^
exec create_or_update_sec_permissi @r_name='Administrators', @p_target='df$CorrespondentAttachment:update', @p_type=20, @p_value=1^
exec create_or_update_sec_permissi @r_name='Administrators', @p_target='df$CorrespondentAttachment:delete', @p_type=20, @p_value=1^

exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='df$CorrespondentAttachment:create', @p_type=20, @p_value=0^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='df$CorrespondentAttachment:update', @p_type=20, @p_value=0^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='df$CorrespondentAttachment:delete', @p_type=20, @p_value=0^

exec create_or_update_sec_permissi @r_name='ReferenceEditor', @p_target='df$OrganizationAttachment:create', @p_type=20, @p_value=1^
exec create_or_update_sec_permissi @r_name='ReferenceEditor', @p_target='df$OrganizationAttachment:update', @p_type=20, @p_value=1^
exec create_or_update_sec_permissi @r_name='ReferenceEditor', @p_target='df$OrganizationAttachment:delete', @p_type=20, @p_value=1^

exec create_or_update_sec_permissi @r_name='Administrators', @p_target='df$OrganizationAttachment:create', @p_type=20, @p_value=1^
exec create_or_update_sec_permissi @r_name='Administrators', @p_target='df$OrganizationAttachment:update', @p_type=20, @p_value=1^
exec create_or_update_sec_permissi @r_name='Administrators', @p_target='df$OrganizationAttachment:delete', @p_type=20, @p_value=1^

exec create_or_update_sec_permissi @r_name='Administrators', @p_target='df$TypicalResolution:create', @p_type=20, @p_value=1^
exec create_or_update_sec_permissi @r_name='Administrators', @p_target='df$TypicalResolution:update', @p_type=20, @p_value=1^
exec create_or_update_sec_permissi @r_name='Administrators', @p_target='df$TypicalResolution:delete', @p_type=20, @p_value=1^

exec create_or_update_sec_permissi @r_name='Administrators', @p_target='thesis.mobileSettings.edit', @p_type=40, @p_value=1^

exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='df$OrganizationAttachment:create', @p_type=20, @p_value=0^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='df$OrganizationAttachment:update', @p_type=20, @p_value=0^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='df$OrganizationAttachment:delete', @p_type=20, @p_value=0^

exec create_or_update_sec_permissi @r_name='Administrators', @p_target='df$ImportDataType.browse', @p_type=10, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='df$ImportDataType.browse', @p_type=10, @p_value=0^

exec create_or_update_sec_permissi @r_name='Administrators', @p_target='transferOfficeFile', @p_type=10, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='transferOfficeFile', @p_type=10, @p_value=0^

exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='df$DocKind.edit', @p_type=10, @p_value=0^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='ts$CardType.edit', @p_type=10, @p_value=0^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$Role.edit', @p_type=10, @p_value=0^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='tm$TaskType.edit', @p_type=10, @p_value=0^

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id)
VALUES ('4b744176-3f88-11e2-b1f4-2387c06904ee',CURRENT_TIMESTAMP,'system',1,20,'df$Position:update',1,'0C018061-B26F-4DE2-A5BE-DFF348347F93');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id)
VALUES ('fa9dac64-3f88-11e2-baa9-abdc5402291f',CURRENT_TIMESTAMP,'system',1,20,'df$Position:delete',1,'0C018061-B26F-4DE2-A5BE-DFF348347F93');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id)
VALUES ('fade084a-3f88-11e2-bfbc-1754d44c59ad',CURRENT_TIMESTAMP,'system',1,20,'df$Position:read',1,'0C018061-B26F-4DE2-A5BE-DFF348347F93');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id)
VALUES ('fae06a86-3f88-11e2-b386-4ffc775f57ea',CURRENT_TIMESTAMP,'system',1,20,'df$Position:create',1,'0C018061-B26F-4DE2-A5BE-DFF348347F93');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id)
VALUES ('fae52ef4-3f88-11e2-8581-470be131402f',CURRENT_TIMESTAMP,'system',1,20,'df$Position:update',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id)
VALUES ('fae52ef4-3f88-11e2-8a34-cf46cd2037e8',CURRENT_TIMESTAMP,'system',1,20,'df$Position:delete',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id)
VALUES ('fae9f362-3f88-11e2-ba71-2bf955c28f6c',CURRENT_TIMESTAMP,'system',1,20,'df$Position:read',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id)
VALUES ('faf11a0c-3f88-11e2-8835-ef8481161ae1',CURRENT_TIMESTAMP,'system',1,20,'df$Position:create',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id)
VALUES ('fb01c992-3f88-11e2-8845-c3747e4f7b90',CURRENT_TIMESTAMP,'system',1,20,'df$Position:update',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id)
VALUES ('fb042bce-3f88-11e2-ac1c-9fc28b598153',CURRENT_TIMESTAMP,'system',1,20,'df$Position:delete',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value_,role_id)
VALUES ('fb068e00-3f88-11e2-a384-23c38be8091f',CURRENT_TIMESTAMP,'system',1,20,'df$Position:create',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c')^

insert into DF_IMPORT_DATA_TYPE (id, create_ts, created_by, version, name, meta_class_name) values
('ff801f90-a389-11e2-a895-f7261fdb7f5a', current_timestamp, 'admin', 1 , 'Документ' , 'df$SimpleDoc');
insert into DF_IMPORT_DATA_TYPE (id, create_ts, created_by, version, name, meta_class_name) values
('33433e50-a38c-11e2-9506-a71c3d8f3fe2', current_timestamp, 'admin', 1, 'Договор' , 'df$Contract');
...
---------------   Simple Doc -----------------
(newId(), current_timestamp, 'admin', 1, 'ff801f90-a389-11e2-a895-f7261fdb7f5a', 'Категория', 'docCategory', 'df$Category');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, 'ff801f90-a389-11e2-a895-f7261fdb7f5a', 'Номер', 'number', 'String');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, 'ff801f90-a389-11e2-a895-f7261fdb7f5a', 'Вид', 'docKind', 'df$DocKind');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, 'ff801f90-a389-11e2-a895-f7261fdb7f5a', 'Подразделение', 'department', 'df$Department');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, 'ff801f90-a389-11e2-a895-f7261fdb7f5a', 'Куратор', 'owner', 'df$Employee');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, 'ff801f90-a389-11e2-a895-f7261fdb7f5a', 'Дата', 'date', 'Date');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, 'ff801f90-a389-11e2-a895-f7261fdb7f5a', 'Отправитель', 'sender', 'df$Company');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, 'ff801f90-a389-11e2-a895-f7261fdb7f5a', 'Рег.номер', 'regNo', 'String');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, 'ff801f90-a389-11e2-a895-f7261fdb7f5a', 'Адресат', 'docOfficeDataAddressees', 'df$Company');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, 'ff801f90-a389-11e2-a895-f7261fdb7f5a', 'Содержание', 'comment', 'String');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, 'ff801f90-a389-11e2-a895-f7261fdb7f5a', 'Дата регистрации', 'regDate', 'Date');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, 'ff801f90-a389-11e2-a895-f7261fdb7f5a', 'Канцелярский вид', 'docOfficeDocKind', 'DocOfficeDocKind');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, 'ff801f90-a389-11e2-a895-f7261fdb7f5a', 'Файлы', 'attachments', 'wf$CardAttachment');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
...
-------------    Contract   -----------------
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Сумма', 'amount', 'BigDecimal');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Описание', 'comment', 'String');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Ставка, %', 'vatRate', 'BigDecimal');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Конт.лицо', 'contactPerson', 'df$ContactPerson');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Вид', 'docKind', 'df$DocKind');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Активный', 'active', 'Boolean');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Сумма НДС', 'vatAmount', 'BigDecimal');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'НДС в сумме', 'vatInclusive', 'Boolean');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Дата', 'date', 'Date');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Контрагент', 'contractor', 'df$Company');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Номер', 'number', 'String');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Подразделение', 'department', 'df$Department');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Организация', 'organization', 'df$Organization');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Условия платежа', 'paymentConditions', 'String');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Куратор', 'owner', 'df$Employee');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Начало обязательств', 'liabilityStart', 'Date');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Окончание обязательств', 'liabilityEnd', 'Date');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Канцелярский вид', 'docOfficeDocKind', 'DocOfficeDocKind');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Категория', 'docCategory', 'df$Category');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Файлы', 'attachments', 'wf$CardAttachment');
insert INTO df_import_data_attr(id, create_ts, created_by, version, import_data_type_id, cell_name, property_name, field_type) values
(newId(), current_timestamp, 'admin', 1, '33433e50-a38c-11e2-9506-a71c3d8f3fe2', 'Валюта', 'currency', 'df$Currency');

exec create_or_update_sec_permissi @r_name='Administrators', @p_target='df$ImportDataType.browse', @p_type=10, @p_value=1;
exec create_or_update_sec_permissi @r_name='Administrators', @p_target='tm$TaskType.browse', @p_type=10, @p_value=1;
exec create_or_update_sec_permissi @r_name='Administrators', @p_target='tm$TaskType.edit', @p_type=10, @p_value=1;
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='df$ImportDataType.browse', @p_type=10, @p_value=0;

exec create_or_update_sec_permissi @r_name='Administrators', @p_target='df$AppIntegrationLog.browse', @p_type=10, @p_value=1;
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='df$AppIntegrationLog.browse', @p_type=10, @p_value=0;
exec create_or_update_sec_permissi @r_name='AppIntegrationRole', @p_target='df$AppIntegrationLog.browse', @p_type=10, @p_value=1;
...
insert into SYS_CONFIG(id, create_ts, created_by, version, name, value_) values
('1dacf0be-25db-11e3-9db8-671686f3c707', current_timestamp, 'admin', 1, 'com.haulmont.thesis.core.config.taskTypeDefault', 'tm$TaskType-836d02a0-68a9-4aa5-b11a-08e9b32c589b-edit');
insert into SYS_CONFIG(id, create_ts, created_by, version, name, value_) values
...
insert into SYS_CONFIG(id, create_ts, created_by, version, name, value_) values
('c40ea551-d399-4a11-b6be-347ca5f27837', current_timestamp, 'admin', 1, 'com.haulmont.thesis.core.config.defaultLetterDocKind', 'df$DocKind-c40ea551-d399-4a11-b6be-347ca5f27837');
^
...
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='portalIntegration', @p_type=10, @p_value=0^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='tm$User.edit:fieldGroupLeft', @p_type=50, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='tm$User.edit:fieldGroupRight', @p_type=50, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='tm$User.edit:split', @p_type=50, @p_value=0^

exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:position', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:password', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:organization', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:ipMask', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:name', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:login', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:firstName', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:middleName', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:lastName', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:changePasswordAtNextLogon', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:email', @p_type=30, @p_value=2^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:active', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:language', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:departmentCode', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:group', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:isMobile', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:activeDirectoryID', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:timeZone', @p_type=30, @p_value=1^
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='sec$User:timeZoneAuto', @p_type=30, @p_value=1^

exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='certificationAuthoritySignatureRequestForm', @p_type=10, @p_value=0^
exec create_or_update_sec_permissi @r_name='Administrators', @p_target='certificationAuthoritySignatureRequestForm', @p_type=10, @p_value=1^

exec create_or_update_sec_permissi @r_name='schedule_task_creator', @p_target='tm$TaskPattern.browse', @p_type=10, @p_value=1^

exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='mobileClientAdministrationWindow', @p_type=10, @p_value=0^

alter table SEC_USER alter column POSITION_ VARCHAR(400)^
...
insert into sec_permission(id, create_ts, created_by, version, permission_type, target, value_, role_id) values
(newid(), current_timestamp, 'system', 1, 10, 'ts$ArchivedAccountDoc.browse', 1, '56e2fce4-fdfc-11e3-a0b9-737e257ecae7');  -- archive access
...
insert into sec_permission(id, create_ts, created_by, version, permission_type, target, value_, role_id) values
(newid(), current_timestamp, 'system', 1, 10, 'ts$ArchivedAccountDoc.browse', 1, '505d37f4-fdfc-11e3-88a0-b7bba68b44d2'); -- archivist
...
insert into sec_permission(id, create_ts, created_by, version, permission_type, target, value_, role_id) values
(newid(), current_timestamp, 'system', 1, 10, 'ts$ArchivedAccountDoc.browse', 0, '96fa7fe9-397d-4bac-b14a-eec2d94de68c'); -- simple user
insert into sec_permission(id, create_ts, created_by, version, permission_type, target, value_, role_id) values
...
insert into sec_permission(id, create_ts, created_by, version, permission_type, target, value_, role_id) values
(newid(), current_timestamp, 'system', 1, 10, 'ts$ArchivedAccountDoc.browse', 1, '0c018061-b26f-4de2-a5be-dff348347f93'); -- admin
insert into sec_permission(id, create_ts, created_by, version, permission_type, target, value_, role_id) values
(newid(), current_timestamp, 'system', 1, 10, 'ts$ArchivedContract.browse', 1, '0c018061-b26f-4de2-a5be-dff348347f93'); -- admin

insert into sec_permission(id, create_ts, created_by, version, permission_type, target, value_, role_id) values
(newid(), current_timestamp, 'system', 1, 20, 'df$OfficeFile:update', 1, '505d37f4-fdfc-11e3-88a0-b7bba68b44d2'); -- archivist
...
insert into sec_permission(id, create_ts, created_by, version, permission_type, target, value_, role_id) values
(newid(), current_timestamp, 'system', 1, 10, 'ts$ArchivedAccountDoc.browse', 1, '7091f5ef-a77a-450a-834a-39406885676e'); -- secretary
insert into sec_permission(id, create_ts, created_by, version, permission_type, target, value_, role_id) values
(newid(), current_timestamp, 'system', 1, 10, 'ts$ArchivistWorkplace', 1, '7091f5ef-a77a-450a-834a-39406885676e'); -- secretary

alter table WF_PROC add HIDDEN_DECISIONS_BPMN varchar(1500);
...
alter table WF_PROC add LOC_NAME varchar(max);
alter table WF_PROC add AVAILABLE_EDE tinyint;
alter table WF_PROC add AVAILABLE_EDE_SESSION_TYPES varchar(500);


exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='ts$OfficeFileTransferLog:create', @p_type=20, @p_value=0;
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='ts$OfficeFileTransferLog:update', @p_type=20, @p_value=0;
exec create_or_update_sec_permissi @r_name='SimpleUser', @p_target='ts$OfficeFileTransferLog:delete', @p_type=20, @p_value=0;

exec create_or_update_sec_permissi @r_name='Archivist', @p_target='ts$OfficeFileTransferLog:create', @p_type=20, @p_value=1;
exec create_or_update_sec_permissi @r_name='Archivist', @p_target='ts$OfficeFileTransferLog:update', @p_type=20, @p_value=1;
exec create_or_update_sec_permissi @r_name='Archivist', @p_target='ts$OfficeFileTransferLog:delete', @p_type=20, @p_value=1;


------------------------------------------------------------------------
alter table WF_PROC alter column STATES varchar(5000)^
...
alter table WF_CARD_COMMENT_USER add VERSION integer not null default 1^
...
alter table DF_ORGANIZATION add OGRN varchar(13)^

alter table SYS_ENTITY_STATISTICS add SEARCH_PICKER_FIELD_THRESHOLD integer;

IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name = 'idx_wci_activity_execution_id' AND object_id = OBJECT_ID('WF_CARD_INFO'))
    BEGIN
       CREATE NONCLUSTERED INDEX idx_wci_activity_execution_id
...
alter table WF_ASSIGNMENT add BY_MAIL_ACTIVITY tinyint^
...
alter table WF_PROC add AVAILABLE_MAIL_ACTIVITY tinyint^
...
alter table DF_ACCOUNT_DOC add ORIGIN_DOC_ID uniqueidentifier^
...
alter table DF_ACCOUNT_DOC add ORIGIN_DOC_DATE datetime^

---

alter table DF_ACCOUNT_DOC add ORIGIN_REV_DOC_ID uniqueidentifier^
...
alter table DF_ACCOUNT_DOC add ORIGIN_REV_DOC_DATE datetime^

---

alter table DF_ACCOUNT_DOC add ORIGIN_COR_DOC_ID uniqueidentifier^
...
alter table DF_ACCOUNT_DOC add ORIGIN_COR_DOC_DATE datetime^
...
alter table TS_EDM_SENDING alter column EDM_SENDING_TYPE integer not null^

---

alter table TS_EDM_SENDING add PARENT_EDM_SENDING_ID uniqueidentifier^
...
create clustered index IDX_EDM_DOC_EVENT_CREATE_TS on TS_EDM_DOCUMENT_EVENT (CREATE_TS)^
create index IDX_EDM_DOC_EVENT_MSG_ENT on TS_EDM_DOCUMENT_EVENT(EDM_MESSAGE_ID, EDM_ENTITY_ID)^

---

alter table TS_EDM_SENDING add LAST_DOC_EVENT_DATE datetime^

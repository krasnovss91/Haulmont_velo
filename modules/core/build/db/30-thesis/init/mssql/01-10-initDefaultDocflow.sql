...
as
begin
  declare @cnt integer, @initDefaultInFirstStart varchar(5);
  ...
  if(@cnt = 0) begin
   insert into DF_TYPICAL_RESOLUTION (id, create_ts, created_by, substituted_creator_id, version, name, text, global)
     values (newid(), current_timestamp, user, 'b18e3c10-0328-11e2-969a-fb0e8fd8c622', 1, 'На рассмотрение:', 'На рассмотрение:', 1);
  end;

  select @cnt = count(id) from DF_TYPICAL_RESOLUTION where name = 'Ознакомить:';
  if(@cnt = 0) begin
    insert into DF_TYPICAL_RESOLUTION (id, create_ts, created_by, substituted_creator_id, version, name, text, global)
    values (newid(), current_timestamp, user, 'b18e3c10-0328-11e2-969a-fb0e8fd8c622', 1, 'Ознакомить:', 'Ознакомить:', 1);
  end;

  select @cnt = count(id) from DF_NUMERATOR where id = 'bebc21e2-fce0-40c6-9202-7cffff7cf88e';
  if(@cnt = 0) begin
    insert into DF_NUMERATOR (id, create_ts, created_by, version, code, script_enabled, script)
...
if(@cnt = 0) begin
  ...
  if(@cnt = 0) begin
    insert into DF_ORGANIZATION (id, create_ts, created_by, version, name, has_attachments) values ('a851beaf-6890-4ab2-b847-b7a810c4c2b9', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Наша организация', 0);
  ...
  if(@cnt = 0) begin
    insert into DF_OFFICE_FILE_NOMENCLATURE (id, create_ts, created_by, version, name, year, ec_mark, category, organization_id) values ('301f91e9-2968-4fc6-ba4e-e3a3ea09d46c', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Входящие', 2021, 0, 1, 'a851beaf-6890-4ab2-b847-b7a810c4c2b9');
  end;

  select @cnt = count(id) from DF_OFFICE_FILE_NOMENCLATURE where id = 'd32b5d42-e202-4df5-89ee-9d6111d6d637';
  if(@cnt = 0) begin
    insert into DF_OFFICE_FILE_NOMENCLATURE (id, create_ts, created_by, version, name, year, ec_mark, category, organization_id) values ('d32b5d42-e202-4df5-89ee-9d6111d6d637', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Исходящие', 2021, 0, 1, 'a851beaf-6890-4ab2-b847-b7a810c4c2b9');
  end;

  select @cnt = count(id) from DF_OFFICE_FILE_NOMENCLATURE where id = '159ab5b8-fb54-4ea6-a6ba-b485fb885010';
  if(@cnt = 0) begin
    insert into DF_OFFICE_FILE_NOMENCLATURE (id, create_ts, created_by, version, name, year, ec_mark, category, organization_id) values ('159ab5b8-fb54-4ea6-a6ba-b485fb885010', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Внутренние', 2021, 0, 1, 'a851beaf-6890-4ab2-b847-b7a810c4c2b9');
  end;

  select @cnt = count(id) from DF_NUMERATOR where id = '215c66b8-ef2e-6608-bd5d-59c3bae94e5e';
  if(@cnt = 0) begin
    insert into DF_NUMERATOR (id, create_ts, created_by, version, code, script_enabled,numerator_format, periodicity, number_initial_value ) values ('215c66b8-ef2e-6608-bd5d-59c3bae94e5e', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Совещания',
    0,'[number(5)]','Y',1);
  end;

  select @cnt = count(id) from DF_NUMERATOR where id = 'b3997576-456d-49e8-964a-24a247d4753d';
  if(@cnt = 0) begin
    insert into DF_NUMERATOR (id, create_ts, created_by, version, code, script_enabled, script) values ('b3997576-456d-49e8-964a-24a247d4753d', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Документы и договоры', 1,
    'def un = com.haulmont.cuba.core.global.AppBeans.get("cuba_UniqueNumbers")
     String numPrefix = ""
     if(binding.variables.containsKey("docOfficeData")) {
       com.haulmont.thesis.core.entity.OfficeFile officeFile = docOfficeData.getOfficeFile()
  ...
  if(@cnt = 0) begin
    insert into DF_NUMERATOR (id, create_ts, created_by, version, code, script_enabled, script) values ('c91d9e66-0034-11e3-8ca5-3f77160974ff', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Приложение к договору', 1,
...
select @cnt = count(id) from DF_NUMERATOR where id = 'f31de086-0034-11e3-b761-873aa0372209';
  if(@cnt = 0) begin
    insert into DF_NUMERATOR (id, create_ts, created_by, version, code, script_enabled, script) values ('f31de086-0034-11e3-b761-873aa0372209', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Дополнительное соглашение', 1,
    'import com.haulmont.cuba.core.app.DataService
      import com.haulmont.cuba.core.global.LoadContext
      import com.haulmont.thesis.core.entity.Doc
      import com.haulmont.thesis.core.entity.DocOfficeData
  ...
  if(@cnt = 0) begin
    insert into DF_NUMERATOR (id, create_ts, created_by, version, code, script_enabled, script) values ('70dfe954-fe9d-11e2-96e0-1f9c56fc4e22', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Письмо', 1,
    'def un = com.haulmont.cuba.core.global.AppBeans.get("cuba_UniqueNumbers")
     String numPrefix = ""
     if (binding.variables.containsKey("docOfficeData")) {
         com.haulmont.thesis.core.entity.OfficeFile officeFile = docOfficeData.getOfficeFile()
  ...
  if(@cnt = 0) begin
    insert into DF_NUMERATOR (id, create_ts, created_by, version, code, script_enabled, script) values ('ab30b1b4-fe9e-11e2-9003-c79b48b9667d', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Приказ', 1,
    'def un = com.haulmont.cuba.core.global.AppBeans.get("cuba_UniqueNumbers")
     String numPrefix = ""
     if (binding.variables.containsKey("docOfficeData")) {
         com.haulmont.thesis.core.entity.OfficeFile officeFile = docOfficeData.getOfficeFile()
  ...
  if(@cnt = 0) begin
    insert into DF_NUMERATOR (id, create_ts, created_by, version, code, script_enabled, script) values ('b8ee4d84-fe9e-11e2-8a75-2ff0c334cf13', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Регламент', 1,
    'def un = com.haulmont.cuba.core.global.AppBeans.get("cuba_UniqueNumbers")
     String numPrefix = ""
     if (binding.variables.containsKey("docOfficeData")) {
         com.haulmont.thesis.core.entity.OfficeFile officeFile = docOfficeData.getOfficeFile()
  ...
  if(@cnt = 0) begin
    insert into DF_NUMERATOR (id, create_ts, created_by, version, code, script_enabled, script) values ('c3b2f4a4-fe9e-11e2-a39a-83fe0d6b8db7', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Инструкция', 1,
    'def un = com.haulmont.cuba.core.global.AppBeans.get("cuba_UniqueNumbers")
     String numPrefix = ""
     if (binding.variables.containsKey("docOfficeData")) {
         com.haulmont.thesis.core.entity.OfficeFile officeFile = docOfficeData.getOfficeFile()
  ...
  if(@cnt = 0) begin
    insert into DF_NUMERATOR (id, create_ts, created_by, version, code, script_enabled, script) values ('d062c9f4-fe9e-11e2-a3fc-cf13c8fd96f7', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Служебная записка', 1,
    'def un = com.haulmont.cuba.core.global.AppBeans.get("cuba_UniqueNumbers")
     String numPrefix = ""
     if (binding.variables.containsKey("docOfficeData")) {
         com.haulmont.thesis.core.entity.OfficeFile officeFile = docOfficeData.getOfficeFile()
    ...
    if(@cnt = 0) begin
      insert into DF_NUMERATOR (id, create_ts, created_by, version, code, script_enabled, script) values ('31dd46b2-2c00-11e3-bbe5-ef5c4a9d25e0', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Вложения', 1,
      'String docNum= "док_"
  ...
  select @initDefaultInFirstStart = value_ from SYS_CONFIG where name='thesis.initDefaultInFirstStart';
  ...
  select @cnt = count(df_office_file_id) from DF_OFF_FILE_NOMENCL_RELATION where delete_ts is null;
  if(@cnt = 0) begin

...
insert into SEC_GROUP (id, create_ts, created_by, version, name, parent_id) values ('cff945e4-e363-0dc0-d70d-4b5bdb2a2269',now(),'system',1,'Архивариус', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93');
insert into SEC_GROUP (id, create_ts, created_by, version, name, parent_id) values ('7dfe5c72-073f-4e1e-9cf4-1b1bad9c0093',now(),'system',1,'Делопроизводители','0fa2b1a5-1d68-4d69-9fbd-dff348347f93');
insert into SEC_GROUP (id, create_ts, created_by, version, name, parent_id) values ('8e6306e2-9e10-414a-b437-24c91ffef804',now(),'system',1,'Ограниченный доступ','0fa2b1a5-1d68-4d69-9fbd-dff348347f93');
insert into SEC_GROUP (id, create_ts, created_by, version, name, parent_id) values ('9e44a053-a31f-4edd-b19b-39e942161dd2',now(),'system',1,'Ограниченный доступ + все договоры','0fa2b1a5-1d68-4d69-9fbd-dff348347f93');
insert into SEC_GROUP (id, create_ts, created_by, version, name, parent_id) values ('b3dc60f5-65b2-47ab-8802-9e8929bf8b29',now(),'system',1,'Ограниченный доступ + все документы','0fa2b1a5-1d68-4d69-9fbd-dff348347f93');
insert into SEC_GROUP (id, create_ts, created_by, version, name, parent_id) values ('9fa89a54-9ffa-11e1-b13e-9f4a54bff17e',now(),'system',1,'Руководитель департамента', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93');
insert into SEC_GROUP (id, create_ts, created_by, version, name, parent_id) values ('8d9ba07c-9ffa-11e1-b99d-8fc5b41c7fbb',now(),'system',1,'Руководитель подразделения', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93')^

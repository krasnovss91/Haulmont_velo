...
^
exec assign_card_creator_default '10-Initiator', 'TaskManagement' ^
...
if(@cnt = 0) begin
insert into SEC_USER_ROLE (id, create_ts, created_by, version, user_id, role_id) values ('2bf2d72c-d773-45b6-9775-826e8294f926', current_timestamp, 'admin', 1, '60885987-1b61-4247-94c7-dff348347f93', '0c018061-b26f-4de2-a5be-dff348347f93');
end;
...
if(@cnt = 0) begin
insert into SEC_USER_ROLE (id, create_ts, created_by, version, user_id, role_id) values ('505c696d-9460-4712-ba27-55053b8f3757', current_timestamp, 'admin', 1, '60885987-1b61-4247-94c7-dff348347f93', 'c06c0cee-2f21-4241-8d6f-76b4cd462f96');
end;
...
if(@cnt = 0) begin
insert into SEC_USER_ROLE (id, create_ts, created_by, version, user_id, role_id) values ('35b174b6-b3b3-4c55-bc62-b854414cef57', current_timestamp, 'admin', 1, '60885987-1b61-4247-94c7-dff348347f93', 'e41f5aa2-3296-4fdc-906e-af2f8660f806');
end;
...
if(@cnt = 0) begin
insert into SEC_USER_ROLE (id, create_ts, created_by, version, user_id, role_id) values ('c362eb7b-f423-4f62-beb2-2fa100e6f116', current_timestamp, 'admin', 1, '60885987-1b61-4247-94c7-dff348347f93', '7091f5ef-a77a-450a-834a-39406885676e');
end;
...
if(@cnt = 0) begin
insert into SEC_USER_ROLE (id, create_ts, created_by, version, user_id, role_id) values ('27282768-1015-4120-bbc9-14a8e5ab7276', current_timestamp, 'admin', 1, '60885987-1b61-4247-94c7-dff348347f93', '47135f12-071b-43d8-bc21-2ff77cd08fb6');
end;
...
if(@cnt = 0) begin
insert into SEC_USER_ROLE (id, create_ts, created_by, version, user_id, role_id) values ('fc843d30-3a61-4dce-a3f5-78ae23fedcdb', current_timestamp, 'admin', 1, '60885987-1b61-4247-94c7-dff348347f93', '3c9abffb-2fae-484e-990c-343b3c1197ca');
end;
...
if(@cnt = 0) begin
insert into SEC_USER_ROLE (id, create_ts, created_by, version, user_id, role_id) values ('922e85ee-efef-4ffa-bfce-214d51ce5c52', current_timestamp, 'admin', 1, '60885987-1b61-4247-94c7-dff348347f93', '7a35c6f8-6a2d-4347-a8c2-3bc887e23c83');
end;
...
if(@cnt = 0) begin
insert into SEC_USER_ROLE (id, create_ts, created_by, version, user_id, role_id) values ('58f80bee-58d7-43dc-b14d-d57de959b36f', current_timestamp, 'admin', 1, '60885987-1b61-4247-94c7-dff348347f93', 'f7ff1ec7-802d-4a42-a7db-1a97e17f893f');
end;
...
if(@cnt = 0) begin
insert into SEC_USER_ROLE (id, create_ts, created_by, version, user_id, role_id) values ('836d8822-ca48-4197-bb7b-78fd37b5076b', current_timestamp, 'admin', 1, '60885987-1b61-4247-94c7-dff348347f93', '0038f3db-ac9c-4323-83e7-356996cc63ae');
end;
...
if(@cnt = 0) begin
insert into SEC_USER_ROLE (id, create_ts, created_by, version, user_id, role_id) values ('3bafe8fd-0967-4d3d-a251-9c4b5ca30fa8', current_timestamp, 'admin', 1, '60885987-1b61-4247-94c7-dff348347f93', '64fec164-5408-4e48-9e72-5a1d214c533e');
end;
...
if(@cnt = 0) begin
insert into SEC_USER_ROLE (id, create_ts, created_by, version, user_id, role_id) values ('264a0a91-3743-4528-a713-e0ce329fb80b', current_timestamp, 'admin', 1, '60885987-1b61-4247-94c7-dff348347f93', 'c0e15ca3-1791-4e52-9882-c88fd72fbac1');
end;
...
if(@cnt = 0) begin
insert into SEC_USER_ROLE (id, create_ts, created_by, version, user_id, role_id) values ('8bb3653d-e8c9-433a-93d8-3aa2f1d142a9', current_timestamp, 'admin', 1, '60885987-1b61-4247-94c7-dff348347f93', '5115e833-4146-4c98-a119-1c06053adb92');
end;
...
if(@cnt = 0) begin
insert into SEC_USER_ROLE (id, create_ts, created_by, version, user_id, role_id) values ('d9914437-4a9a-48c3-b42e-12febe47c61b', current_timestamp, 'admin', 1, '60885987-1b61-4247-94c7-dff348347f93', 'af439810-0f11-4a21-b239-7df2df83bbc6');
end;
select @cnt = count(id) from SEC_USER_ROLE where id = '1186d871-3663-4f29-889b-7d0ffa56b267'
...
if(@cnt = 0) begin
insert into TM_PROJECT_GROUP (id, name, create_ts, created_by, version) values ('b875aded-88e7-4090-9f81-a1a5fac75192', 'Основной проект', current_timestamp, 'admin', 1);
end;

select @cnt = count(CATEGORY_ID) from TM_TASK_TYPE where CATEGORY_ID = '836d02a0-68a9-4aa5-b11a-08e9b32c589b';
if(@cnt = 0) begin
insert into SYS_CATEGORY (ID, NAME, ENTITY_TYPE, IS_DEFAULT, CREATE_TS, CREATED_BY, VERSION, DISCRIMINATOR)
values ('836d02a0-68a9-4aa5-b11a-08e9b32c589b', 'Основной', 'tm$Task', 0, current_timestamp, USER, 1, 2);
insert into TM_TASK_TYPE (CATEGORY_ID, create_ts, created_by, version, category_attrs_place, tab_name)
values ('836d02a0-68a9-4aa5-b11a-08e9b32c589b', current_timestamp, 'admin', 1, 1, 'Доп. поля');
end;

select @cnt = count(id) from SYS_CONFIG where name = 'workflow.sms.smsProviderClassName';
if(@cnt = 0) begin
insert into SYS_CONFIG (id, create_ts, created_by, version, name, value_) values ('f6a9be40-16ac-11e2-8783-7b7ddae9940d', current_timestamp, 'admin', 1, 'workflow.sms.smsProviderClassName', 'com.haulmont.thesis.core.app.SmsTrafficProvider');
end;

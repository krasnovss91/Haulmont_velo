...
postUpdate.add({
    ...
    def updateSql = "update DF_DOC d " +
            "set DOC_KIND_ID = 'a36454de7af411eab49f8b8e95b826ef' " +
            "where d.DOC_KIND_ID = '512e83a3d8c945f6b0ded1949a55bced' and d.is_template = 0 " +
    ...
    try {
        ...
        def query = em.createNativeQuery("select ID from SYS_CATEGORY where ID = '512e83a3d8c945f6b0ded1949a55bced'")
        List list = query.getResultList()
        def oldDocKindExists = !list.isEmpty()
        if (oldDocKindExists) {
            query = em.createNativeQuery("select ID from SYS_CATEGORY where ID = 'a36454de7af411eab49f8b8e95b826ef'")

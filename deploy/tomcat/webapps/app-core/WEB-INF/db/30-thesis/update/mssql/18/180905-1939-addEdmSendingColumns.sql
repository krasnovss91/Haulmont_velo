...
alter table TS_EDM_SENDING add FILE_ID uniqueidentifier^
alter table TS_EDM_SENDING add SUBSCRIBER_ID uniqueidentifier^
alter table TS_EDM_SENDING add RESPONSE_SIGNATURE_REQUIRED tinyint^

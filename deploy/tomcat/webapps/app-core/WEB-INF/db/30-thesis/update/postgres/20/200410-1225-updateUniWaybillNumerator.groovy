...
postUpdate.add({
    ...
    def seqName = "seq_un_accountdocwaybill"
    def domainName = "accountdocwaybill"
    def domainNameForUpdate = "accountdocuniwaybill"
    def seqExists = false
    ...
    if (seqExists) {
        ...
        if (cur != null) {
            un.setCurrentNumber(domainNameForUpdate, cur)
        }
    }

...
<head>
    ...
    <title><#if locale == "ru">Дизайнер процессов Тезис<#else>Thesis Workflow Designer</#if></title>
...
<div id="top">
    <div class="logo i18n">Thesis Workflow Designer</div>
    <div id="toolbar"></div>
</div>
...
<div id="left">
    ...
    <ul id="modulesAccordionView">
        ...
        <li>
            <h2 class="i18n">Documents</h2>

            <div>
                <div id='module-category-documents'></div>
            </div>
        </li>

        <li>
            <h2 class="i18n">Tasks</h2>

            <div>
                <div id='module-category-tasks'></div>
            </div>
        </li>
    </ul>
...
<div id="helpPanel">
    <div class="hd i18n">Welcome to the Thesis Workflow Designer</div>

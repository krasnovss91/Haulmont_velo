...
set CATALINA_OPTS=%CATALINA_OPTS% -Dapp.home="%CATALINA_BASE%/conf/app_home"
...
set CATALINA_OPTS=%CATALINA_OPTS% -Duser.language=ru -Duser.region=RU -Dhttp.maxRedirects=300